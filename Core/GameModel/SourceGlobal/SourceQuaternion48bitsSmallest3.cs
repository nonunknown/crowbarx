    ...
    public class SourceQuaternion48bitsSmallest3
    {
        ...
        private void ComputeQuaternion()
        {
            if (!theQuaternionIsComputed)
            {
                ...
                if (missingComponentType == MISSING_COMPONENT_X)
                {
                ...
                else if (missingComponentType == MISSING_COMPONENT_Y)
                {
                    theQuaternion.x = a;
                ...
                else if (missingComponentType == MISSING_COMPONENT_Z)
                {
                    theQuaternion.x = a;
                    theQuaternion.y = b;
                ...
                else if (missingComponentType == MISSING_COMPONENT_W)
                {
                    theQuaternion.x = a;
                    theQuaternion.y = b;
                    theQuaternion.z = c;
        ...
        {
            return Math.Sqrt(1d - a * a - b * b - c * c);
        }
        ...
        private const double Minimum = -1 / 1.414214d;
        private const double Maximum = 1d / 1.414214d;
