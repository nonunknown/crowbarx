    ...
    public class SourceQuaternion48bitsViaBytes
    {
        ...
        private void ComputeQuaternion()
        {
            if (!theQuaternionIsComputed)
            {
                ...
                {
                    missingComponentSign = 1d;
                }

                double a;
                double b;
                double c;
                a = (uIntegerA - 16384L) / 23168d;
                b = (uIntegerB - 16384L) / 23168d;
                c = (uIntegerC - 16384L) / 23168d;
                if (missingComponentIndex == (long)MISSING_COMPONENT_X)
                {
                ...
                else if (missingComponentIndex == (long)MISSING_COMPONENT_Y)
                {
                    theQuaternion.x = c;
                ...
                else if (missingComponentIndex == (long)MISSING_COMPONENT_Z)
                {
                    theQuaternion.x = b;
                    theQuaternion.y = c;
                ...
                else if (missingComponentIndex == (long)MISSING_COMPONENT_W)
                {
                    theQuaternion.x = a;
                    theQuaternion.y = b;
                    theQuaternion.z = c;
        ...
        {
            return Math.Sqrt(1d - a * a - b * b - c * c) * missingComponentSign;
        }
