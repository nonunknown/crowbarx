...
namespace Crowbar
{
    public abstract class SourceModel
    {
        ...
        public static SourceModel Create(string mdlPathFileName, AppEnums.SupportedMdlVersion overrideVersion, ref int version)
        {
            ...
            try
            {
                storedVersion = GetVersion(mdlPathFileName);
                ...
                {
                    version = Conversions.ToInteger(EnumHelper.GetDescription(overrideVersion));
                }
            ...
            try
            {
                ...
                if (inputFileStream is object)
                {
                    try
                    {
                        ...
                        string id;
                        id = Conversions.ToString(inputFileReader.ReadChars(4));
        ...
        {
            AppEnums.FilesFoundFlags status;
            status = AppEnums.FilesFoundFlags.AllFilesFound;
            return status;
        }
        ...
        protected void WriteFile(string pathFileName, WriteFileDelegate writeFileAction, string value, SourceFileData fileData)
        {
            ...
            try
            {
                ...
                if (outputFileStream is object)
                {
                    ...
                    {
                        if (theOutputFileBinaryWriter is object)
                        {
        ...
        {
            SourceModelProgress?.Invoke(this, new SourceModelProgressEventArgs(progress, message));
        }
        ...
        protected string WriteAccessedBytesDebugFile(string debugPathFileName, FileSeekLog fileSeekLog)
        {
            ...
            try
            {
                ...
                var debugFile = new AccessedBytesDebugFile(theOutputFileTextWriter);
        ...
        private void GetHeaderDataFromMdlFile(List<string> ioTextLines, AppEnums.SupportedMdlVersion mdlVersionOverride)
        {
            ...
            ioTextLines.Add("");
            string fileTypeId;
            fileTypeId = theMdlFileDataGeneric.theID;
            if (fileTypeId == "IDST")
            {
