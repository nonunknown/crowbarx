...
namespace Crowbar
{
    public class SourceMdlFile37
    {
        ...
        public SourceMdlFile37(BinaryReader mdlFileReader, SourceMdlFileData37 mdlFileData)
        {
        ...
        public SourceMdlFile37(BinaryWriter mdlFileWriter, SourceMdlFileData37 mdlFileData)
        {
        ...
        public void ReadMdlHeader00(string logDescription)
        {
            ...
            {
                theMdlFileData.theFileSeekLog.Add(fileOffsetStart, fileOffsetEnd, logDescription + " (Actual version: " + theMdlFileData.version.ToString() + "; override version: 37)");
            }
        }
        ...
        public void ReadMdlHeader01(string logDescription)
        {
            ...
            theMdlFileData.animationGroupCount = theInputFileReader.ReadInt32();
            theMdlFileData.animationGroupOffset = theInputFileReader.ReadInt32();
            theMdlFileData.boneDescCount = theInputFileReader.ReadInt32();
            theMdlFileData.boneDescOffset = theInputFileReader.ReadInt32();
            ...
            if (theMdlFileData.boneCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int boneIndex = 0, loopTo = theMdlFileData.boneCount - 1; boneIndex <= loopTo; boneIndex++)
                    {
                        ...
                        for (int x = 0, loopTo2 = aBone.unused.Length - 1; x <= loopTo2; x++)
            ...
            if (theMdlFileData.boneControllerCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.boneControllerCount - 1; i <= loopTo; i++)
                    {
                        ...
                        var aBoneController = new SourceMdlBoneController37();
            ...
            if (theMdlFileData.localAttachmentCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.localAttachmentCount - 1; i <= loopTo; i++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var anAttachment = new SourceMdlAttachment37();
            ...
            if (theMdlFileData.hitboxSetCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.hitboxSetCount - 1; i <= loopTo; i++)
                    {
                        ...
                        var aHitboxSet = new SourceMdlHitboxSet37();
        ...
        public void ReadBoneDescs()
        {
            if (theMdlFileData.boneDescCount > 0)
            {
                long boneDescInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                try
                {
                    theInputFileReader.BaseStream.Seek(theMdlFileData.boneDescOffset, SeekOrigin.Begin);
                    fileOffsetStart = theInputFileReader.BaseStream.Position;
                    theMdlFileData.theBoneDescs = new List<SourceMdlBoneDesc37>(theMdlFileData.boneDescCount);
                    for (int i = 0, loopTo = theMdlFileData.boneCount - 1; i <= loopTo; i++)
                    {
                        boneDescInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                        var aBoneDesc = new SourceMdlBoneDesc37();
                        aBoneDesc.nameOffset = theInputFileReader.ReadInt32();
                        aBoneDesc.parentBoneIndex = theInputFileReader.ReadInt32();
                        aBoneDesc.position = new SourceVector();
                        aBoneDesc.position.x = theInputFileReader.ReadSingle();
                        aBoneDesc.position.y = theInputFileReader.ReadSingle();
                        aBoneDesc.position.z = theInputFileReader.ReadSingle();
                        aBoneDesc.rotation = new SourceVector();
                        aBoneDesc.rotation.x = theInputFileReader.ReadSingle();
                        aBoneDesc.rotation.y = theInputFileReader.ReadSingle();
                        aBoneDesc.rotation.z = theInputFileReader.ReadSingle();
                        aBoneDesc.positionScale = new SourceVector();
                        aBoneDesc.positionScale.x = theInputFileReader.ReadSingle();
                        aBoneDesc.positionScale.y = theInputFileReader.ReadSingle();
                        aBoneDesc.positionScale.z = theInputFileReader.ReadSingle();
                        aBoneDesc.rotationScale = new SourceVector();
                        aBoneDesc.rotationScale.x = theInputFileReader.ReadSingle();
                        aBoneDesc.rotationScale.y = theInputFileReader.ReadSingle();
                        aBoneDesc.rotationScale.z = theInputFileReader.ReadSingle();
                        ...
                        aBoneDesc.poseToBoneColumn0.x = theInputFileReader.ReadSingle();
                        aBoneDesc.poseToBoneColumn1.x = theInputFileReader.ReadSingle();
                        aBoneDesc.poseToBoneColumn2.x = theInputFileReader.ReadSingle();
                        aBoneDesc.poseToBoneColumn3.x = theInputFileReader.ReadSingle();
                        aBoneDesc.poseToBoneColumn0.y = theInputFileReader.ReadSingle();
                        aBoneDesc.poseToBoneColumn1.y = theInputFileReader.ReadSingle();
                        aBoneDesc.poseToBoneColumn2.y = theInputFileReader.ReadSingle();
                        aBoneDesc.poseToBoneColumn3.y = theInputFileReader.ReadSingle();
                        aBoneDesc.poseToBoneColumn0.z = theInputFileReader.ReadSingle();
                        aBoneDesc.poseToBoneColumn1.z = theInputFileReader.ReadSingle();
                        aBoneDesc.poseToBoneColumn2.z = theInputFileReader.ReadSingle();
                        aBoneDesc.poseToBoneColumn3.z = theInputFileReader.ReadSingle();
                        for (int x = 0, loopTo1 = aBoneDesc.unused.Length - 1; x <= loopTo1; x++)
                            aBoneDesc.unused[x] = theInputFileReader.ReadInt32();
                        theMdlFileData.theBoneDescs.Add(aBoneDesc);
                        inputFileStreamPosition = theInputFileReader.BaseStream.Position;
                        if (aBoneDesc.nameOffset != 0)
                        {
                            theInputFileReader.BaseStream.Seek(boneDescInputFileStreamPosition + aBoneDesc.nameOffset, SeekOrigin.Begin);
                            fileOffsetStart2 = theInputFileReader.BaseStream.Position;
                            aBoneDesc.theName = FileManager.ReadNullTerminatedString(theInputFileReader);
                            fileOffsetEnd2 = theInputFileReader.BaseStream.Position - 1L;
                            if (!theMdlFileData.theFileSeekLog.ContainsKey(fileOffsetStart2))
                            {
                                theMdlFileData.theFileSeekLog.Add(fileOffsetStart2, fileOffsetEnd2, "aBoneDesc.theName = " + aBoneDesc.theName);
                            }
                        }
                        else if (aBoneDesc.theName is null)
                        {
                            aBoneDesc.theName = "";
                        }
                    ...
                    fileOffsetEnd = theInputFileReader.BaseStream.Position - 1L;
                    theMdlFileData.theFileSeekLog.Add(fileOffsetStart, fileOffsetEnd, "theMdlFileData.theBoneDescs " + theMdlFileData.theBoneDescs.Count.ToString());
                }
        ...
        public void ReadAnimGroups()
        {
            if (theMdlFileData.animationGroupCount > 0)
            {
                ...
                try
                {
                    theInputFileReader.BaseStream.Seek(theMdlFileData.animationGroupOffset, SeekOrigin.Begin);
                    fileOffsetStart = theInputFileReader.BaseStream.Position;
                    theMdlFileData.theAnimGroups = new List<SourceMdlAnimGroup37>(theMdlFileData.animationGroupCount);
                    for (int i = 0, loopTo = theMdlFileData.animationGroupCount - 1; i <= loopTo; i++)
                    {
                        // seqInputFileStreamPosition = Me.theInputFileReader.BaseStream.Position
                        var anAnimGroup = new SourceMdlAnimGroup37();
                        anAnimGroup.group = theInputFileReader.ReadInt32();
                        anAnimGroup.index = theInputFileReader.ReadInt32();
                        theMdlFileData.theAnimGroups.Add(anAnimGroup);
                    ...
                    fileOffsetEnd = theInputFileReader.BaseStream.Position - 1L;
                    theMdlFileData.theFileSeekLog.Add(fileOffsetStart, fileOffsetEnd, "theMdlFileData.theAnimGroups " + theMdlFileData.theAnimGroups.Count.ToString());
                    theMdlFileData.theFileSeekLog.LogToEndAndAlignToNextStart(theInputFileReader, fileOffsetEnd, 4, "theMdlFileData.theAnimGroups alignment");
                }
                catch (Exception ex)
                {
                    int debug = 4242;
        ...
        public void ReadSequences()
        {
            if (theMdlFileData.localSequenceCount > 0)
            {
                ...
                try
                {
                    ...
                    fileOffsetStart = theInputFileReader.BaseStream.Position;
                    theMdlFileData.theSequenceDescs = new List<SourceMdlSequenceDesc37>(theMdlFileData.localSequenceCount);
                    for (int i = 0, loopTo = theMdlFileData.localSequenceCount - 1; i <= loopTo; i++)
                    {
                        ...
                        var aSeqDesc = new SourceMdlSequenceDesc37();
                        ...
                        for (int x = 0, loopTo1 = aSeqDesc.unused.Length - 1; x <= loopTo1; x++)
        ...
        public void ReadSequenceGroups()
        {
            ...
            {
                long sequenceGroupInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                try
                {
                    ...
                    theMdlFileData.theIncludeModelFileNames = new List<string>();
                    for (int sequenceGroupIndex = 0, loopTo = theMdlFileData.sequenceGroupCount - 1; sequenceGroupIndex <= loopTo; sequenceGroupIndex++)
                    {
                        ...
                        var aSequenceGroup = new SourceMdlSequenceGroup37();
                        ...
                        if (aSequenceGroup.theName == "shared_animation")
                        {
                            theMdlFileData.theIncludeModelFileNames.Add(aSequenceGroup.theFileName);
                        }
        ...
        public void ReadLocalAnimationDescs()
        {
            ...
            {
                long animationDescInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                try
                {
                    ...
                    fileOffsetStart = theInputFileReader.BaseStream.Position;
                    theMdlFileData.theAnimationDescs = new List<SourceMdlAnimationDesc37>(theMdlFileData.animationCount);
                    for (int i = 0, loopTo = theMdlFileData.animationCount - 1; i <= loopTo; i++)
                    {
                        animationDescInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                        // fileOffsetStart = Me.theInputFileReader.BaseStream.Position
                        var anAnimationDesc = new SourceMdlAnimationDesc37();
                        ...
                        for (int x = 0, loopTo1 = anAnimationDesc.unused.Length - 1; x <= loopTo1; x++)
        ...
        public void ReadBodyParts()
        {
            if (theMdlFileData.bodyPartCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.bodyPartCount - 1; i <= loopTo; i++)
                    {
                        bodyPartInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var aBodyPart = new SourceMdlBodyPart37();
            ...
            if (theMdlFileData.ikChainCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.ikChainCount - 1; i <= loopTo; i++)
                    {
                        ...
                        var anIkChain = new SourceMdlIkChain37();
            ...
            if (theMdlFileData.localIkAutoPlayLockCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.localIkAutoPlayLockCount - 1; i <= loopTo; i++)
                    {
                        ...
                        var anIkLock = new SourceMdlIkLock37();
        ...
        public void ReadTextures()
        {
            if (theMdlFileData.textureCount > 0)
            {
                ...
                for (int i = 0, loopTo = theMdlFileData.textureCount - 1; i <= loopTo; i++)
                {
                    ...
                    var aTexture = new SourceMdlTexture37();
                    ...
                    for (int x = 0, loopTo1 = aTexture.unknown.Length - 1; x <= loopTo1; x++)
            ...
            if (aHitboxSet.hitboxCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = aHitboxSet.hitboxCount - 1; j <= loopTo; j++)
                    {
                        ...
                        var aHitbox = new SourceMdlHitbox37();
                        ...
                        for (int x = 0, loopTo1 = aHitbox.unused.Length - 1; x <= loopTo1; x++)
        ...
        private void ReadPoseKeys(long seqInputFileStreamPosition, SourceMdlSequenceDesc37 aSeqDesc)
        {
        ...
        private void ReadEvents(long seqInputFileStreamPosition, SourceMdlSequenceDesc37 aSeqDesc)
        {
            if (aSeqDesc.eventCount > 0 && aSeqDesc.eventOffset != 0)
            {
                try
                {
                    ...
                    for (int j = 0, loopTo = aSeqDesc.eventCount - 1; j <= loopTo; j++)
                    {
                        // eventInputFileStreamPosition = Me.theInputFileReader.BaseStream.Position
                        var anEvent = new SourceMdlEvent37();
        ...
        private void ReadAutoLayers(long seqInputFileStreamPosition, SourceMdlSequenceDesc37 aSeqDesc)
        {
            if (aSeqDesc.autoLayerCount > 0 && aSeqDesc.autoLayerOffset != 0)
            {
                try
                {
                    ...
                    for (int j = 0, loopTo = aSeqDesc.autoLayerCount - 1; j <= loopTo; j++)
                    {
                        autoLayerInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                        var anAutoLayer = new SourceMdlAutoLayer37();
        ...
        private void ReadMdlAnimBoneWeights(long seqInputFileStreamPosition, SourceMdlSequenceDesc37 aSeqDesc)
        {
        ...
        private void ReadSequenceIkLocks(long seqInputFileStreamPosition, SourceMdlSequenceDesc37 aSeqDesc)
        {
            if (aSeqDesc.ikLockCount > 0 && aSeqDesc.ikLockOffset != 0)
            {
                try
                {
                    ...
                    for (int j = 0, loopTo = aSeqDesc.ikLockCount - 1; j <= loopTo; j++)
                    {
        ...
        private void ReadMdlAnimIndexes(long seqInputFileStreamPosition, SourceMdlSequenceDesc37 aSeqDesc)
        {
            if (aSeqDesc.groupSize[0] * aSeqDesc.groupSize[1] > 0 && aSeqDesc.blendOffset != 0)
            {
                try
                {
                    int animIndexCount;
                    ...
                    long fileOffsetStart;
                    long fileOffsetEnd;
                    theInputFileReader.BaseStream.Seek(seqInputFileStreamPosition + aSeqDesc.blendOffset, SeekOrigin.Begin);
                    fileOffsetStart = theInputFileReader.BaseStream.Position;
                    ...
                    if (!theMdlFileData.theFileSeekLog.ContainsKey(fileOffsetStart))
                    {
                        theMdlFileData.theFileSeekLog.Add(fileOffsetStart, fileOffsetEnd, "aSeqDesc.theAnimDescIndexes " + aSeqDesc.theAnimDescIndexes.Count.ToString());
                    }

                    theMdlFileData.theFileSeekLog.LogToEndAndAlignToNextStart(theInputFileReader, fileOffsetEnd, 4, "aSeqDesc.theAnimDescIndexes alignment");
                }
                catch (Exception ex)
                {
                    int debug = 4242;
        ...
        private void ReadSequenceKeyValues(long seqInputFileStreamPosition, SourceMdlSequenceDesc37 aSeqDesc)
        {
        ...
        private void ReadAnimations(long animationDescInputFileStreamPosition, SourceMdlAnimationDesc37 anAnimationDesc)
        {
            if (anAnimationDesc.animOffset > 0)
            {
                ...
                try
                {
                    ...
                    for (int boneIndex = 0, loopTo = theMdlFileData.theBones.Count - 1; boneIndex <= loopTo; boneIndex++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var anAnimation = new SourceMdlAnimation37();
        ...
        private void ReadAnimationValues(long animationInputFileStreamPosition, SourceMdlAnimation37 anAnimation, int offsetIndex, int frameCount, ref long fileOffsetEnd)
        {
            if (anAnimation.animationValueOffsets[offsetIndex] > 0)
            {
                ...
                byte currentTotal;
                byte validCount;
                List<SourceMdlAnimationValue10> animValues;
        ...
        private void ReadMdlMovements(long animInputFileStreamPosition, SourceMdlAnimationDesc37 anAnimationDesc)
        {
        ...
        private void ReadMdlIkRules(long animInputFileStreamPosition, SourceMdlAnimationDesc37 anAnimationDesc)
        {
            if (anAnimationDesc.ikRuleCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = anAnimationDesc.ikRuleCount - 1; j <= loopTo; j++)
                    {
                        ikRuleInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                        var anIkRule = new SourceMdlIkRule37();
                        ...
                        if (double.IsNaN(anIkRule.influenceStart))
                        {
                            anIkRule.influenceStart = 0d;
                        }

                        if (double.IsNaN(anIkRule.influencePeak))
                        {
                            anIkRule.influencePeak = 0d;
                        }

                        if (double.IsNaN(anIkRule.influenceTail))
                        {
                            anIkRule.influenceTail = 0d;
                        }

                        if (double.IsNaN(anIkRule.influenceEnd))
                        {
                            anIkRule.influenceEnd = 0d;
                        }

                        if (double.IsNaN(anIkRule.contact))
                        {
                            anIkRule.contact = 0d;
                        }
        ...
        private void ReadMdlIkErrors(long ikRuleInputFileStreamPosition, SourceMdlIkRule37 anIkRule, int frameCount)
        {
            ...
            int ikErrorStart;
            int ikErrorEnd;
            var ikErrorCount = default(int);
            try
            {
                ikErrorStart = (int)Math.Round(anIkRule.influenceStart * (frameCount - 1));
                ikErrorEnd = (int)Math.Round(anIkRule.influenceEnd * (frameCount - 1));
            ...
            if (ikErrorCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = ikErrorCount - 1; j <= loopTo; j++)
                    {
                        // ikErrorInputFileStreamPosition = Me.theInputFileReader.BaseStream.Position
                        var anIkError = new SourceMdlIkError37();
            ...
            if (anIkChain.linkCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = anIkChain.linkCount - 1; j <= loopTo; j++)
                    {
                        ...
                        var anIkLink = new SourceMdlIkLink37();
            ...
            if (aBodyPart.modelCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = aBodyPart.modelCount - 1; j <= loopTo; j++)
                    {
                        ...
                        var aModel = new SourceMdlModel37();
                        ...
                        for (int x = 0, loopTo1 = aModel.unused.Length - 1; x <= loopTo1; x++)
        ...
        private void ReadEyeballs(long modelInputFileStreamPosition, SourceMdlModel37 aModel)
        {
            if (aModel.eyeballCount > 0 && aModel.eyeballOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int eyeballIndex = 0, loopTo = aModel.eyeballCount - 1; eyeballIndex <= loopTo; eyeballIndex++)
                    {
                        eyeballInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                        var anEyeball = new SourceMdlEyeball37();
            ...
            if (aModel.meshCount > 0 && aModel.meshOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int meshIndex = 0, loopTo = aModel.meshCount - 1; meshIndex <= loopTo; meshIndex++)
                    {
                        ...
                        for (int x = 0, loopTo1 = aMesh.unused.Length - 1; x <= loopTo1; x++)
        ...
        private void ReadVertexes(long modelInputFileStreamPosition, SourceMdlModel37 aModel)
        {
            ...
            {
                long vertexInputFileStreamPosition;
                // Dim inputFileStreamPosition As Long
                long fileOffsetStart;
                long fileOffsetEnd;
                // Dim fileOffsetStart2 As Long
                ...
                try
                {
                    ...
                    fileOffsetStart = theInputFileReader.BaseStream.Position;
                    if (theMdlFileData.theVertexes is null)
                    {
                        theMdlFileData.theVertexes = new List<SourceMdlVertex37>();
                    }
                    ...
                    for (int vertexIndex = 0, loopTo = aModel.vertexCount - 1; vertexIndex <= loopTo; vertexIndex++)
                    {
                        ...
                        var aVertex = new SourceMdlVertex37();
                        ...
                        theMdlFileData.theVertexes.Add(aVertex);
        ...
        private void ReadTangents(long modelInputFileStreamPosition, SourceMdlModel37 aModel)
        {
            if (aModel.vertexCount > 0 && aModel.tangentOffset != 0)
            {
                ...
                try
                {
                    ...
                    {
                        vertexInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                        var aTangent = new SourceVector4D();
            ...
            if (aFlex.vertCount > 0 && aFlex.vertOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int k = 0, loopTo = aFlex.vertCount - 1; k <= loopTo; k++)
                    {
                        ...
                        var aVertAnim = new SourceMdlVertAnim37();
        ...
        public void CreateFlexFrameList()
        {
            ...
            SourceMdlModel37 aModel;
            SourceMdlMesh37 aMesh;
            SourceMdlFlex37 aFlex;
            FlexFrame37 searchedFlexFrame;
            theMdlFileData.theFlexFrames = new List<FlexFrame37>();
            ...
            if (theMdlFileData.theFlexDescs is object && theMdlFileData.theFlexDescs.Count > 0)
            {
                ...
                List<List<FlexFrame37>> flexDescToFlexFrames;
                ...
                {
                    var flexFrameList = new List<FlexFrame37>();
        ...
        protected SourceMdlFileData37 theMdlFileData;
