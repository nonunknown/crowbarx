...
namespace Crowbar
{
    ...
    public class SourceModel37 : SourceModel36
    {
        ...
        public new AppEnums.StatusMessage WriteMeshSmdFile(string smdPathFileName, int lodIndex, SourceVtxModel06 aVtxModel, SourceMdlModel37 aModel, int bodyPartVertexIndexStart)
        {
            var status = AppEnums.StatusMessage.Success;
            try
            {
                theOutputFileTextWriter = File.CreateText(smdPathFileName);
                var smdFile = new SourceSmdFile37(theOutputFileTextWriter, theMdlFileData);
        ...
        protected override void ReadMdlFileHeader_Internal()
        {
            ...
            {
                theMdlFileData = new SourceMdlFileData37();
                theMdlFileDataGeneric = theMdlFileData;
            }

            var mdlFile = new SourceMdlFile37(theInputFileReader, theMdlFileData);
        ...
        {
            var qcFile = new SourceQcFile37(theOutputFileTextWriter, theQcPathFileName, theMdlFileData, thePhyFileDataGeneric, theVtxFileData, theName);
            try
            {
        ...
        {
            var physicsMeshSmdFile = new SourceSmdFile37(theOutputFileTextWriter, theMdlFileData, thePhyFileDataGeneric);
            try
            {
        ...
        {
            var vrdFile = new SourceVrdFile37(theOutputFileTextWriter, theMdlFileData);
            try
            {
        ...
        {
            var vertexAnimationVtaFile = new SourceVtaFile37(theOutputFileTextWriter, theMdlFileData);
            try
            {
