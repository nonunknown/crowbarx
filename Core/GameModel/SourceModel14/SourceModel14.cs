...
namespace Crowbar
{
    public class SourceModel14 : SourceModel06
    {
        ...
        public override AppEnums.StatusMessage WriteReferenceMeshFiles(string modelOutputPath)
        {
            ...
            // Next
            // End If
            SourceMdlBodyPart14 aBodyPart;
            SourceMdlModel14 aBodyModel;
            // Dim smdFileName As String
        ...
        public AppEnums.StatusMessage WriteBoneAnimationSmdFile(string smdPathFileName, SourceMdlSequenceDesc10 aSequence, int blendIndex)
        {
            ...
            try
            {
                ...
                var smdFile = new SourceSmdFile14(theOutputFileTextWriter, theMdlFileData);
        ...
        protected override void ReadMdlFileHeader_Internal()
        {
            ...
            {
                theMdlFileData = new SourceMdlFileData14();
                theMdlFileDataGeneric = theMdlFileData;
            }

            var mdlFile = new SourceMdlFile14(theInputFileReader, theMdlFileData);
        ...
        protected override void WriteQcFile()
        {
            ...
            var qcFile = new SourceQcFile14(theOutputFileTextWriter, theQcPathFileName, theMdlFileData, theName);
            try
            {
        ...
        {
            var mdlFile = new SourceMdlFile14(theOutputFileBinaryWriter, theMdlFileData);
