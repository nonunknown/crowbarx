...
namespace Crowbar
{
    public class SourceMdlFile2531
    {
            ...
            if (theMdlFileData.boneCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int boneIndex = 0, loopTo = theMdlFileData.boneCount - 1; boneIndex <= loopTo; boneIndex++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var aBone = new SourceMdlBone2531();
            ...
            if (theMdlFileData.boneControllerCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.boneControllerCount - 1; i <= loopTo; i++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var aBoneController = new SourceMdlBoneController2531();
        ...
        public void ReadAttachments()
        {
            if (theMdlFileData.localAttachmentCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int attachmentIndex = 0, loopTo = theMdlFileData.localAttachmentCount - 1; attachmentIndex <= loopTo; attachmentIndex++)
                    {
                        attachmentInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var anAttachment = new SourceMdlAttachment2531();
                        ...
                        else if (anAttachment.theName is null)
                        {
            ...
            if (theMdlFileData.hitBoxSetCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.hitBoxSetCount - 1; i <= loopTo; i++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var aHitboxSet = new SourceMdlHitboxSet2531();
            ...
            if (theMdlFileData.localSequenceCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.localSequenceCount - 1; i <= loopTo; i++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var aSequence = new SourceMdlSequenceDesc2531();
                        ...
                        // Next
                        for (int x = 0, loopTo3 = aSequence.test02.Length - 1; x <= loopTo3; x++)
                        ...
                        for (int x = 0, loopTo4 = aSequence.unknown04.Length - 1; x <= loopTo4; x++)
                            aSequence.unknown04[x] = theInputFileReader.ReadInt32();
                        for (int x = 0, loopTo5 = aSequence.unknown05.Length - 1; x <= loopTo5; x++)
            ...
            if (theMdlFileData.localAnimationCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.localAnimationCount - 1; i <= loopTo; i++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var anAnimationDesc = new SourceMdlAnimationDesc2531();
            ...
            if (theMdlFileData.textureCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.textureCount - 1; i <= loopTo; i++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var aTexture = new SourceMdlTexture2531();
            ...
            if (theMdlFileData.includeModelCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.includeModelCount - 1; i <= loopTo; i++)
                    {
                        ...
                        var anIncludeModel = new SourceMdlIncludeModel2531();
                        anIncludeModel.fileNameOffset = theInputFileReader.ReadInt32();
                        for (int x = 0, loopTo1 = anIncludeModel.unknown.Length - 1; x <= loopTo1; x++)
            ...
            if (theMdlFileData.bodyPartCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.bodyPartCount - 1; i <= loopTo; i++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var aBodyPart = new SourceMdlBodyPart2531();
            ...
            if (theMdlFileData.localPoseParamaterCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.localPoseParamaterCount - 1; i <= loopTo; i++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var aPoseParamDesc = new SourceMdlPoseParamDesc2531();
            ...
            if (theMdlFileData.sequenceGroupCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int sequenceGroupIndex = 0, loopTo = theMdlFileData.sequenceGroupCount - 1; sequenceGroupIndex <= loopTo; sequenceGroupIndex++)
                    {
                        ...
                        var aSequenceGroup = new SourceMdlSequenceGroup2531();
        ...
        public void CreateFlexFrameList()
        {
            ...
            SourceMdlModel2531 aModel;
            SourceMdlMesh2531 aMesh;
            SourceMdlFlex2531 aFlex;
            FlexFrame2531 searchedFlexFrame;
            ...
            if (theMdlFileData.theFlexDescs is object && theMdlFileData.theFlexDescs.Count > 0)
            {
                ...
                List<List<FlexFrame2531>> flexDescToFlexFrames;
                ...
                {
                    var flexFrameList = new List<FlexFrame2531>();
        ...
        private void ReadTriggers(long quatInterpBoneInputFileStreamPosition, SourceMdlQuatInterpBone2531 aQuatInterpBone)
        {
            ...
            try
            {
                ...
                {
                    fileOffsetStart = theInputFileReader.BaseStream.Position;
                    var aTrigger = new SourceMdlQuatInterpInfo2531();
            ...
            if (aHitboxSet.hitboxCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = aHitboxSet.hitboxCount - 1; j <= loopTo; j++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var aHitbox = new SourceMdlHitbox2531();
            ...
            if (aBodyPart.modelCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = aBodyPart.modelCount - 1; j <= loopTo; j++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var aModel = new SourceMdlModel2531();
                        ...
                        for (int x = 0, loopTo1 = aModel.unknown01.Length - 1; x <= loopTo1; x++)
                        ...
                        for (int x = 0, loopTo2 = aModel.unknown02.Length - 1; x <= loopTo2; x++)
                        ...
                        for (int x = 0, loopTo3 = aModel.unknown03.Length - 1; x <= loopTo3; x++)
            ...
            if (aModel.eyeballCount > 0 && aModel.eyeballOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int k = 0, loopTo = aModel.eyeballCount - 1; k <= loopTo; k++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var anEyeball = new SourceMdlEyeball2531();
            ...
            if (aModel.meshCount > 0 && aModel.meshOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int meshIndex = 0, loopTo = aModel.meshCount - 1; meshIndex <= loopTo; meshIndex++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var aMesh = new SourceMdlMesh2531();
        ...
        private void ReadFlexes(long meshInputFileStreamPosition, SourceMdlMesh2531 aMesh)
        {
            ...
            try
            {
                ...
                for (int k = 0, loopTo = aMesh.flexCount - 1; k <= loopTo; k++)
                {
                    ...
                    var aFlex = new SourceMdlFlex2531();
        ...
        private void ReadVertexesType0(long modelInputFileStreamPosition, SourceMdlModel2531 aModel)
        {
            if (aModel.vertexCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = aModel.vertexCount - 1; j <= loopTo; j++)
                    {
                        // hitboxInputFileStreamPosition = Me.theInputFileReader.BaseStream.Position
                        // fileOffsetStart = Me.theInputFileReader.BaseStream.Position
                        var aVertex = new SourceMdlType0Vertex2531();
                        for (int x = 0, loopTo1 = aVertex.weight.Length - 1; x <= loopTo1; x++)
                            aVertex.weight[x] = theInputFileReader.ReadByte();
                        aVertex.unknown1 = theInputFileReader.ReadByte();
                        for (int x = 0, loopTo2 = aVertex.boneIndex.Length - 1; x <= loopTo2; x++)
            ...
            if (aModel.vertexCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = aModel.vertexCount - 1; j <= loopTo; j++)
                    {
                        ...
                        // fileOffsetStart = Me.theInputFileReader.BaseStream.Position
                        var aVertex = new SourceMdlType1Vertex2531();
                        ...
                        for (int x = 0, loopTo1 = aVertex.unknown.Length - 1; x <= loopTo1; x++)
            ...
            if (aModel.vertexCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = aModel.vertexCount - 1; j <= loopTo; j++)
                    {
                        // hitboxInputFileStreamPosition = Me.theInputFileReader.BaseStream.Position
                        // fileOffsetStart = Me.theInputFileReader.BaseStream.Position
                        var aVertex = new SourceMdlType2Vertex2531();
            ...
            if (aModel.vertexCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = aModel.vertexCount - 1; j <= loopTo; j++)
                    {
                        // hitboxInputFileStreamPosition = Me.theInputFileReader.BaseStream.Position
                        // fileOffsetStart = Me.theInputFileReader.BaseStream.Position
                        var aTangent = new SourceMdlTangent2531();
            ...
            if (theMdlFileData.boneCount > 0 && anAnimationDesc.animOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int boneIndex = 0, loopTo = theMdlFileData.boneCount - 1; boneIndex <= loopTo; boneIndex++)
                    {
                        ...
                        // fileOffsetStart = Me.theInputFileReader.BaseStream.Position
                        var anAnimation = new SourceMdlAnimation2531();
        ...
        private void ReadAnimationValues(long animationValuesInputFileStreamPosition, int frameCount, List<SourceMdlAnimationValue2531> animationValues, string debugDescription)
        {
            ...
            var anAnimationValue = new SourceMdlAnimationValue2531();
            byte currentTotal;
            byte validCount;
            try
            {
