...
namespace Crowbar
{
    public class SourceModel10 : SourceModel06
    {
        ...
        public override bool SequenceGroupMdlFilesAreUsed
        {
            get
            {
                return theMdlFileData is object && theMdlFileData.sequenceGroupCount > 1 && theMdlFileData.sequenceGroupCount == theSequenceGroupMdlPathFileNames.Count;
            }
        }
        ...
        public override bool HasTextureData
        {
            get
            {
                return theMdlFileData.textureCount > 0 || theTextureMdlFileData10 is object;
            }
        }
        ...
        public override AppEnums.FilesFoundFlags CheckForRequiredFiles()
        {
            ...
            string mdlPath;
            string mdlFileNameWithoutExtension;
            string mdlExtension;
            string textureMdlFileName;
            try
            {
                ...
                for (int sequenceGroupIndex = 1, loopTo = theMdlFileData.sequenceGroupCount - 1; sequenceGroupIndex <= loopTo; sequenceGroupIndex++)
                {
                    string aSequenceGroupMdlFileName;
                    string aSequenceGroupMdlPathFileName;
        ...
        public override AppEnums.StatusMessage ReadSequenceGroupMdlFiles()
        {
            ...
            SourceMdlSequenceGroup10 aSequenceGroup;
            string mdlPath;
            string sequenceGroupMdlFileName;
            string sequenceGroupMdlPathFileName;
        ...
        {
            var status = AppEnums.StatusMessage.Success;
            SourceMdlSequenceDesc10 aSequenceDesc;
            string smdPath;
            // Dim smdFileName As String
            string smdPathFileName;
            try
        ...
        public AppEnums.StatusMessage WriteBoneAnimationSmdFile(string smdPathFileName, SourceMdlSequenceDesc10 aSequence, int blendIndex)
        {
            ...
            try
            {
                ...
                var smdFile = new SourceSmdFile10(theOutputFileTextWriter, theMdlFileData);
        ...
        public override AppEnums.StatusMessage WriteAccessedBytesDebugFiles(string debugPath)
        {
            ...
            if (theSequenceGroupMdlFileDatas10 is object)
            {
                string fileName;
                string fileNameWithoutExtension;
                string fileExtension;
                for (int i = 0, loopTo = theSequenceGroupMdlFileDatas10.Count - 1; i <= loopTo; i++)
                {
                    fileName = theName + " " + "MDL_LOG";
            ...
            if (theTextureMdlFileData10 is object)
            {
                debugPathFileName = Path.Combine(debugPath, theName + " " + "MDL_LOG");
                NotifySourceModelProgress(AppEnums.ProgressOptions.WritingFileStarted, debugPathFileName);
        ...
        protected override void ReadMdlFileHeader_Internal()
        {
            ...
            var mdlFile = new SourceMdlFile10(theInputFileReader, theMdlFileData);
        ...
        {
            if (theSequenceGroupMdlFileDatas10 is null)
            {
                theSequenceGroupMdlFileDatas10 = new List<SourceMdlFileData10>();
            }

            var aSequenceGroupMdlFileData10 = new SourceMdlFileData10();
            ...
            var sequenceGroupMdlFile = new SourceMdlFile10(theInputFileReader, aSequenceGroupMdlFileData10);
        ...
        {
            if (theTextureMdlFileData10 is null)
            {
                theTextureMdlFileData10 = new SourceMdlFileData10();
            }

            var textureMdlFile = new SourceMdlFile10(theInputFileReader, theTextureMdlFileData10);
            textureMdlFile.ReadMdlHeader();
            textureMdlFile.ReadTextures();
            textureMdlFile.ReadSkins();
            if (theMdlFileData.theTextures is null)
            {
        ...
        protected override void WriteQcFile()
        {
            ...
            var qcFile = new SourceQcFile10(theOutputFileTextWriter, theQcPathFileName, theMdlFileData, theName);
            try
            {
        ...
        {
            var mdlFile = new SourceMdlFile10(theOutputFileBinaryWriter, theMdlFileData);
