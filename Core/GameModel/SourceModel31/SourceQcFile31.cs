    ...
    public class SourceQcFile31 : SourceQcFile
    {
        ...
        private void WriteLodCommand()
        {
            ...
            if (theVtxFileData is object && theMdlFileData.theBodyParts is object)
            {
                ...
                SortedList<double, bool> aLodListOfFacialFlags;
                double switchPoint;
        ...
        private void WriteHBoxRelatedCommands_MDL27to30()
        {
            ...
            if (theMdlFileData.theHitboxes_MDL27to30 is null || theMdlFileData.theHitboxes_MDL27to30.Count < 1)
            {
                return;
            }
        ...
        private void WriteHBoxRelatedCommands()
        {
            ...
            bool hitBoxWasAutoGenerated = false;
            bool skipBoneInBBoxCommandWasUsed = false;
            if (theMdlFileData.theHitboxSets is null || theMdlFileData.theHitboxSets.Count < 1)
            {
                return;
            }
            ...
            SourceMdlHitboxSet31 aHitboxSet;
        ...
        private void WriteSequenceOrDeclareSequenceCommand()
        {
            ...
            if (theMdlFileData.theSequenceDescs is object)
            {
                ...
                {
                    SourceMdlSequenceDesc31 aSequenceDesc;
