    ...
    public class SourceMdlFile31
    {
        ...
        public void ReadHitboxes_MDL27to30()
        {
            if (theMdlFileData.hitboxCount_MDL27to30 > 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = theMdlFileData.hitboxCount_MDL27to30 - 1; j <= loopTo; j++)
                    {
                        hitboxInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                        var aHitbox = new SourceMdlHitbox31();
            ...
            if (theMdlFileData.hitboxSetCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.hitboxSetCount - 1; i <= loopTo; i++)
                    {
                        ...
                        var aHitboxSet = new SourceMdlHitboxSet31();
        ...
        public void ReadSequences()
        {
            if (theMdlFileData.localSequenceCount > 0)
            {
                ...
                long inputFileStreamPosition;
                var fileOffsetStart = default(long);
                long fileOffsetEnd;
                long fileOffsetStart2;
                long fileOffsetEnd2;
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.localSequenceCount - 1; i <= loopTo; i++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var aSeqDesc = new SourceMdlSequenceDesc31();
                        ...
                        if (theMdlFileData.version == 27)
                        {
                            theInputFileReader.BaseStream.Seek(inputFileStreamPosition + 4052L, SeekOrigin.Begin);
                        }
                        else if (theMdlFileData.version == 28)
                        {
                            theInputFileReader.BaseStream.Seek(inputFileStreamPosition + 4044L, SeekOrigin.Begin);
                        }
                        else if (theMdlFileData.version == 29 || theMdlFileData.version == 30)
                        {
                            theInputFileReader.BaseStream.Seek(inputFileStreamPosition + 4056L, SeekOrigin.Begin);
                        }
                        else
                        {
                            theInputFileReader.BaseStream.Seek(inputFileStreamPosition + 4060L, SeekOrigin.Begin);
                        }
            ...
            if (theMdlFileData.sequenceGroupCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int sequenceGroupIndex = 0, loopTo = theMdlFileData.sequenceGroupCount - 1; sequenceGroupIndex <= loopTo; sequenceGroupIndex++)
                    {
                        ...
                        var aSequenceGroup = new SourceMdlSequenceGroup31();
            ...
            if (theMdlFileData.animationCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.animationCount - 1; i <= loopTo; i++)
                    {
                        ...
                        // fileOffsetStart = Me.theInputFileReader.BaseStream.Position
                        var anAnimationDesc = new SourceMdlAnimationDesc31();
            ...
            if (theMdlFileData.bodyPartCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.bodyPartCount - 1; i <= loopTo; i++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var aBodyPart = new SourceMdlBodyPart31();
        ...
        public void ReadTextures()
        {
            if (theMdlFileData.textureCount > 0)
            {
                ...
                for (int i = 0, loopTo = theMdlFileData.textureCount - 1; i <= loopTo; i++)
                {
                    ...
                    var aTexture = new SourceMdlTexture31();
            ...
            if (anAnimationDesc.animOffset > 0)
            {
                ...
                try
                {
                    ...
                    for (int boneIndex = 0, loopTo = theMdlFileData.theBones.Count - 1; boneIndex <= loopTo; boneIndex++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var anAnimation = new SourceMdlAnimation31();
            ...
            if (aBodyPart.modelCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = aBodyPart.modelCount - 1; j <= loopTo; j++)
                    {
                        ...
                        var aModel = new SourceMdlModel31();
            ...
            if (aModel.meshCount > 0 && aModel.meshOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int meshIndex = 0, loopTo = aModel.meshCount - 1; meshIndex <= loopTo; meshIndex++)
                    {
                        ...
                        if (theMdlFileData.version == 27)
                        {
                            for (int x = 0, loopTo1 = aMesh.unused_MDL27.Length - 1; x <= loopTo1; x++)
                                aMesh.unused_MDL27[x] = theInputFileReader.ReadInt32();
                        }
                        else
                        {
                            for (int x = 0, loopTo2 = aMesh.unused.Length - 1; x <= loopTo2; x++)
            ...
            if (aModel.vertexCount > 0 && aModel.vertexOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int vertexIndex = 0, loopTo = aModel.vertexCount - 1; vertexIndex <= loopTo; vertexIndex++)
                    {
                        ...
                        var aVertex = new SourceMdlVertex31();
        ...
        {
            if (aModel.vertexCount > 0 && aModel.boneWeightsOffset_MDL27to30 != 0 && aModel.theVertexes is object)
            {
                ...
                try
                {
                    ...
                    foreach (SourceMdlVertex31 aVertex in aModel.theVertexes)
                    {
                        ...
                        var aBoneWeight = new SourceMdlBoneWeight31();
        ...
        {
            if (aModel.vertexCount > 0 && aModel.normalOffset_MDL27to30 != 0 && aModel.theVertexes is object)
            {
                // Dim vertexInputFileStreamPosition As Long
                // Dim inputFileStreamPosition As Long
                long fileOffsetStart;
        ...
        {
            if (aModel.vertexCount > 0 && aModel.texCoordOffset_MDL27to30 != 0 && aModel.theVertexes is object)
            {
                // Dim vertexInputFileStreamPosition As Long
                // Dim inputFileStreamPosition As Long
                long fileOffsetStart;
