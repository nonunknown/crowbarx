...
namespace Crowbar
{
    public class SourceSmdFile36
    {
        ...
        public SourceSmdFile36(StreamWriter outputFileStream, SourceMdlFileData36 mdlFileData)
        {
            theOutputFileStreamWriter = outputFileStream;
            theMdlFileData = mdlFileData;
        }

        public SourceSmdFile36(StreamWriter outputFileStream, SourceMdlFileData36 mdlFileData, SourcePhyFileData phyFileData)
        {
            theOutputFileStreamWriter = outputFileStream;
            theMdlFileData = mdlFileData;
        ...
        public void WriteSkeletonSectionForAnimation(SourceMdlSequenceDescBase aSequenceDescBase, SourceMdlAnimationDescBase anAnimationDescBase)
        {
            ...
            for (int frameIndex = 0, loopTo = anAnimationDesc.frameCount - 1; frameIndex <= loopTo; frameIndex++)
            {
                ...
                for (int i = 0, loopTo1 = theAnimationFrameLines.Count - 1; i <= loopTo1; i++)
                {
                    ...
                    {
                        if (anAnimationDesc.theMovements is object)
                        {
        ...
        // 
        // }
        private void CalcAnimation(SourceMdlSequenceDesc aSequenceDesc, SourceMdlAnimationDesc36 anAnimationDesc, int frameIndex)
        {
            double s;
            SourceMdlBone37 aBone;
