...
namespace Crowbar
{
    public class SourceMdlAnimationDesc36 : SourceMdlAnimationDescBase
    {
        ...
        public List<SourceMdlSequenceDesc36> theLinkedSequences = new List<SourceMdlSequenceDesc36>();
    }
}