...
namespace Crowbar
{
    public class SourceQcFile36 : SourceQcFile
    {
        ...
        public void WriteModelCommand(SourceMdlBodyPart37 aBodyPart)
        {
            ...
            aBodyModel.theSmdFileNames[0] = SourceFileNamesModule.CreateBodyGroupSmdFileName(aBodyModel.theSmdFileNames[0], bodyPartIndex, 0, 0, theModelName, Conversions.ToString(theMdlFileData.theBodyParts[0].theModels[0].name));
            if (Program.TheApp.Settings.DecompileQcUseMixedCaseForKeywordsIsChecked)
            {
                line = "$Model ";
            }
        ...
        private void FillInWeightLists()
        {
            ...
            {
                SourceMdlSequenceDesc36 aSeqDesc;
        ...
        {
            string line = "";
            SourceMdlSequenceGroup37 aSequenceGroup;
        ...
        private void WriteSequenceOrDeclareSequenceCommand()
        {
            ...
            if (theMdlFileData.theSequenceDescs is object)
            {
                ...
                {
                    SourceMdlSequenceDesc36 aSequenceDesc;
        ...
        private void WriteSequenceOptions(SourceMdlSequenceDesc36 aSequenceDesc)
        {
            ...
            SourceMdlAnimationDesc36 firstAnimDesc;
        ...
        private void WriteCollisionModelOrCollisionJointsOptions()
        {
            ...
            if (thePhyFileData.theSourcePhyEditParamsSection.jointMergeMap is object && thePhyFileData.theSourcePhyEditParamsSection.jointMergeMap.Count > 0)
            {
            ...
            for (int i = 0, loopTo = thePhyFileData.theSourcePhyPhysCollisionModels.Count - 1; i <= loopTo; i++)
            {
                ...
                if (aSourcePhysCollisionModel.theDragCoefficientIsValid)
                {
                    ...
                    line += "\" ";
                    line += aSourcePhysCollisionModel.theDragCoefficient.ToString("0.######", Program.TheApp.InternalNumberFormat);
                    theOutputFileStreamWriter.WriteLine(line);
                }
                ...
                if (aSourcePhysCollisionModel.theRollingDragCoefficientIsValid)
                {
                    ...
                    line += aSourcePhysCollisionModel.theName;
                    line += "\" ";
                    line += aSourcePhysCollisionModel.theRollingDragCoefficient.ToString("0.######", Program.TheApp.InternalNumberFormat);
                    theOutputFileStreamWriter.WriteLine(line);
                }
        ...
        private void WriteHBoxRelatedCommands()
        {
            ...
            SourceMdlHitboxSet37 aHitboxSet;
        ...
        {
            string line = "";
            SourceMdlBoneController37 boneController;
            ...
            try
            {
                if (theMdlFileData.theBoneControllers is object)
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.theBoneControllers.Count - 1; i <= loopTo; i++)
                    {
                        ...
                        line += "\" ";
                        line += boneController.type.ToString(Program.TheApp.InternalNumberFormat);
                        line += " ";
