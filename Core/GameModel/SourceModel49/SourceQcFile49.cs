...
namespace Crowbar
{
    public class SourceQcFile49 : SourceQcFile
    {
        ...
        public void WriteModelCommand(SourceMdlBodyPart aBodyPart)
        {
            ...
            aBodyModel.theSmdFileNames[0] = SourceFileNamesModule.CreateBodyGroupSmdFileName(aBodyModel.theSmdFileNames[0], bodyPartIndex, 0, 0, theModelName, Conversions.ToString(aBodyPart.theModels[0].name));
            if (Program.TheApp.Settings.DecompileQcUseMixedCaseForKeywordsIsChecked)
            {
                line = "$Model ";
            }
                    ...
                    if (aModel.theEyeballs is object && aModel.theEyeballs.Count > 0)
                    {
                        ...
                        for (int eyeballIndex = 0, loopTo = aModel.theEyeballs.Count - 1; eyeballIndex <= loopTo; eyeballIndex++)
                        {
                            ...
                            if (anEyeball.theTextureIndex == -1)
                            {
                                ...
                                for (int i = 0, loopTo1 = aModel.theEyeballs.Count - 1; i <= loopTo1; i++)
                                {
                                    if (i == eyeballIndex)
                                    {
                                        continue;
                ...
                if (aBodyPart.theModels is object && aBodyPart.theModels.Count > 0)
                {
                    ...
                    if (aModel.theEyeballs is object && aModel.theEyeballs.Count > 0)
                    {
                        ...
                        for (int eyeballIndex = 0, loopTo = aModel.theEyeballs.Count - 1; eyeballIndex <= loopTo; eyeballIndex++)
                        {
                            ...
                            for (int flexFrameIndex = 1, loopTo1 = aBodyPart.theFlexFrames.Count - 1; flexFrameIndex <= loopTo1; flexFrameIndex++)
                            {
                            ...
                            // For flexFrameIndex As Integer = 1 To Me.theMdlFileData.theFlexFrames.Count - 1
                            // aFlexFrame = Me.theMdlFileData.theFlexFrames(flexFrameIndex)
                            for (int flexFrameIndex = 1, loopTo2 = aBodyPart.theFlexFrames.Count - 1; flexFrameIndex <= loopTo2; flexFrameIndex++)
                            {
                                aFlexFrame = aBodyPart.theFlexFrames[flexFrameIndex];
                                if ((aFlexFrame.flexName ?? "") == (eyelidName ?? "") || aFlexFrame.flexHasPartner && (aFlexFrame.flexPartnerName ?? "") == (eyelidName ?? ""))
                                {
                                    if (aFlexFrame.flexes[0].target3 == 11d)
                                    {
                                        frameIndex = flexFrameIndex;
                                        break;
                                    }
                            ...
                            // For flexFrameIndex As Integer = 1 To Me.theMdlFileData.theFlexFrames.Count - 1
                            // aFlexFrame = Me.theMdlFileData.theFlexFrames(flexFrameIndex)
                            for (int flexFrameIndex = 1, loopTo3 = aBodyPart.theFlexFrames.Count - 1; flexFrameIndex <= loopTo3; flexFrameIndex++)
                            {
                                aFlexFrame = aBodyPart.theFlexFrames[flexFrameIndex];
                                if ((aFlexFrame.flexName ?? "") == (eyelidName ?? "") || aFlexFrame.flexHasPartner && (aFlexFrame.flexPartnerName ?? "") == (eyelidName ?? ""))
                                {
                            ...
                            // For flexFrameIndex As Integer = 1 To Me.theMdlFileData.theFlexFrames.Count - 1
                            // aFlexFrame = Me.theMdlFileData.theFlexFrames(flexFrameIndex)
                            for (int flexFrameIndex = 1, loopTo4 = aBodyPart.theFlexFrames.Count - 1; flexFrameIndex <= loopTo4; flexFrameIndex++)
                            {
                                aFlexFrame = aBodyPart.theFlexFrames[flexFrameIndex];
                                if ((aFlexFrame.flexName ?? "") == (eyelidName ?? "") || aFlexFrame.flexHasPartner && (aFlexFrame.flexPartnerName ?? "") == (eyelidName ?? ""))
                                {
        ...
        {
            if (theBodyPartForFlexWriting.theFlexFrames is object && theBodyPartForFlexWriting.theFlexFrames.Count > 1)
            {
                WriteFlexLines();
        ...
        private void WriteFlexLines()
        {
            ...
            int bodyPartIndex;
            bodyPartIndex = theMdlFileData.theBodyParts.IndexOf(theBodyPartForFlexWriting);
            line = "";
            theOutputFileStreamWriter.WriteLine(line);
            line = Constants.vbTab;
            line += "flexfile";
            ...
            // For frameIndex As Integer = 1 To Me.theMdlFileData.theFlexFrames.Count - 1
            // aFlexFrame = Me.theMdlFileData.theFlexFrames(frameIndex)
            for (int frameIndex = 1, loopTo = theBodyPartForFlexWriting.theFlexFrames.Count - 1; frameIndex <= loopTo; frameIndex++)
            {
        ...
        public void WriteAttachmentCommand()
        {
            ...
            if (theMdlFileData.theAttachments is object)
            {
                line = "";
                theOutputFileStreamWriter.WriteLine(line);
                for (int attachmentIndex = 0, loopTo = theMdlFileData.theAttachments.Count - 1; attachmentIndex <= loopTo; attachmentIndex++)
                {
                    SourceMdlAttachment anAttachment;
                    anAttachment = theMdlFileData.theAttachments[attachmentIndex];
                    ...
                    {
                        line += attachmentIndex.ToString(Program.TheApp.InternalNumberFormat);
                    }
                    else
                    {
                        line += "\"";
        ...
        public void WriteIllumPositionCommand()
        {
            ...
            else
            {
                ...
                SourceMdlAttachment illumPosAttachment;
                illumPosAttachment = theMdlFileData.theAttachments[theMdlFileData.illumPositionAttachmentNumber - 1];
        ...
        private void WriteCorrectiveAnimationBlock()
        {
            ...
            {
                string line = "";
                string correctiveAnimationSmdRelativePathFileName;
        ...
        private void WriteSequenceOptions(SourceMdlSequenceDesc aSequenceDesc)
        {
            ...
            SourceMdlAnimationDesc49 firstAnimDesc;
        ...
        private void WriteCmdListOptions(SourceMdlSequenceDesc aSequenceDesc, SourceMdlAnimationDesc49 anAnimationDesc, SourceMdlAnimationDesc49 impliedAnimDesc)
        {
            ...
            if (anAnimationDesc.theIkRules is object)
            {
                ...
                foreach (SourceMdlIkRule anIkRule in anAnimationDesc.theIkRules)
                {
                    ...
                    tempInteger = (int)Math.Round(Math.Round(anIkRule.contact * endFrameIndex));
                    ...
                    line += " contact ";
                    line += tempInteger.ToString(Program.TheApp.InternalNumberFormat);
                    line += " fakeorigin ";
                    line += anIkRule.pos.x.ToString("0.##", Program.TheApp.InternalNumberFormat);
                    line += " ";
                    line += anIkRule.pos.y.ToString("0.##", Program.TheApp.InternalNumberFormat);
                    line += " ";
                    line += anIkRule.pos.z.ToString("0.##", Program.TheApp.InternalNumberFormat);
                    SourceVector angles;
                    angles = MathModule.ToEulerAngles(anIkRule.q);
                    line += " fakerotate ";
                    line += angles.x.ToString("0.##", Program.TheApp.InternalNumberFormat);
                    line += " ";
                    line += angles.y.ToString("0.##", Program.TheApp.InternalNumberFormat);
                    line += " ";
                    line += angles.z.ToString("0.##", Program.TheApp.InternalNumberFormat);
                    line += " floor ";
                    line += anIkRule.floor.ToString("0.##", Program.TheApp.InternalNumberFormat);
                    line += " height ";
                    line += anIkRule.height.ToString("0.##", Program.TheApp.InternalNumberFormat);
                    ...
                    // pRule->radius = verify_atof( token );
                    line += " radius ";
                    line += anIkRule.radius.ToString("0.##", Program.TheApp.InternalNumberFormat);
                    line += " range ";
                    tempInteger = (int)Math.Round(Math.Round(anIkRule.influenceStart * endFrameIndex));
                    // NOTE: Subtract max frame from value if over max frame. 
                    while (tempInteger > endFrameIndex)
                    {
                        tempInteger -= endFrameIndex;
                    ...
                    line += tempInteger.ToString(Program.TheApp.InternalNumberFormat);
                    line += " ";
                    tempInteger = (int)Math.Round(Math.Round(anIkRule.influencePeak * endFrameIndex));
                    // NOTE: Subtract max frame from value if over max frame. 
                    while (tempInteger > endFrameIndex)
                    {
                        tempInteger -= endFrameIndex;
                    ...
                    line += tempInteger.ToString(Program.TheApp.InternalNumberFormat);
                    line += " ";
                    tempInteger = (int)Math.Round(Math.Round(anIkRule.influenceTail * endFrameIndex));
                    // NOTE: Subtract max frame from value if over max frame. 
                    ...
                    line += tempInteger.ToString(Program.TheApp.InternalNumberFormat);
                    line += " ";
                    tempInteger = (int)Math.Round(Math.Round(anIkRule.influenceEnd * endFrameIndex));
                    // NOTE: Subtract max frame from value if over max frame. 
                    ...
                    line += tempInteger.ToString(Program.TheApp.InternalNumberFormat);
                    line += " target ";
                    line += anIkRule.slot.ToString(Program.TheApp.InternalNumberFormat);
                    ...
                    if (aSequenceDesc is object)
                    {
                        ...
                        else if (anAnimationDesc.theMovements is object && anAnimationDesc.theMovements.Count > 0)
                        {
                            line += " usesequence ";
                        }
                        else if (aSequenceDesc.theAutoLayers is object && aSequenceDesc.theAutoLayers.Count > 0)
                        {
                            ...
                            SourceMdlSequenceDesc otherSequence;
                            SourceMdlAnimationDesc49 otherAnimationDesc;
                            for (int j = 0, loopTo = aSequenceDesc.theAutoLayers.Count - 1; j <= loopTo; j++)
                            {
                                layer = aSequenceDesc.theAutoLayers[j];
                                otherSequence = theMdlFileData.theSequenceDescs[layer.sequenceIndex];
                                for (int k = 0, loopTo1 = aSequenceDesc.theAnimDescIndexes.Count - 1; k <= loopTo1; k++)
                                {
            ...
            if (anAnimationDesc.theMovements is object && anAnimationDesc.theMovements.Count > 0)
            {
            ...
            if (aSeqDesc.autoLayerCount > 0)
            {
                ...
                for (int j = 0, loopTo = aSeqDesc.theAutoLayers.Count - 1; j <= loopTo; j++)
                {
                    ...
                    else
                    {
                        ...
                        line += otherSequenceName;
                        line += "\"";
                        var anAnimationDesc = theMdlFileData.theAnimationDescs[aSeqDesc.theAnimDescIndexes[0]];
                        int endFrameIndex = anAnimationDesc.frameCount - 1;
                        double influenceStart;
                        double influencePeak;
                        double influenceTail;
                        double influenceEnd;
                        string influenceStartText;
                        string influencePeakText;
                        string influenceTailText;
                        string influenceEndText;
                        if ((layer.flags & SourceMdlAutoLayer.STUDIO_AL_POSE) == 0)
                        {
                            ...
                            // End While
                            influenceStartText = influenceStart.ToString("0", Program.TheApp.InternalNumberFormat);
                            influencePeak = layer.influencePeak * endFrameIndex;
                            // 'NOTE: Subtract max frame from value if over max frame. 
                            // While influencePeak > endFrameIndex
                            // influencePeak -= endFrameIndex
                            // End While
                            influencePeakText = influencePeak.ToString("0", Program.TheApp.InternalNumberFormat);
                            influenceTail = layer.influenceTail * endFrameIndex;
                            // 'NOTE: Subtract max frame from value if over max frame. 
                            // While influenceTail > endFrameIndex
                            // influenceTail -= endFrameIndex
                            // End While
                            influenceTailText = influenceTail.ToString("0", Program.TheApp.InternalNumberFormat);
                            ...
                            // influenceEnd -= endFrameIndex
                            // End While
                            influenceEndText = influenceEnd.ToString("0", Program.TheApp.InternalNumberFormat);
                        }
                        else
                        {
                            influenceStartText = layer.influenceStart.ToString("0.######", Program.TheApp.InternalNumberFormat);
                            influencePeakText = layer.influencePeak.ToString("0.######", Program.TheApp.InternalNumberFormat);
                            influenceTailText = layer.influenceTail.ToString("0.######", Program.TheApp.InternalNumberFormat);
                            influenceEndText = layer.influenceEnd.ToString("0.######", Program.TheApp.InternalNumberFormat);
                        }
        ...
        private void WriteHBoxCommands(List<SourceMdlHitbox> theHitboxes, string commentTag, string hitboxSetName, ref bool theSkipBoneInBBoxCommandWasUsed)
        {
            ...
            for (int j = 0, loopTo = theHitboxes.Count - 1; j <= loopTo; j++)
            {
                ...
                if (theMdlFileData.version >= 49 && aHitbox.unknown != 0d)
                {
                    ...
                    line += " ";
                    line += aHitbox.unknown.ToString("0.######", Program.TheApp.InternalNumberFormat);
                }
        ...
        public void WriteBodyGroupCommand()
        {
            ...
            if (theMdlFileData.theBodyParts is object && theMdlFileData.theBodyParts.Count > 0)
            {
                ...
                for (int bodyPartIndex = 0, loopTo = theMdlFileData.theBodyParts.Count - 1; bodyPartIndex <= loopTo; bodyPartIndex++)
                {
                    ...
                    if (theVtxFileData is object && theVtxFileData.theVtxBodyParts is object && theVtxFileData.theVtxBodyParts.Count > 0)
                    {
                    ...
                    if (aBodyPart.theModels is object && aBodyPart.theModels.Count > 0)
                    {
                        for (int modelIndex = 0, loopTo1 = aBodyPart.theModels.Count - 1; modelIndex <= loopTo1; modelIndex++)
                        {
                            ...
                            if (aVtxBodyPart is object && aVtxBodyPart.theVtxModels is object && aVtxBodyPart.theVtxModels.Count > 0)
                            {
                            ...
                            line = Constants.vbTab;
                            if (aBodyModel.name[0] == '\0' && aVtxModel is object && aVtxModel.theVtxModelLods[0].theVtxMeshes is null)
                            {
                                line += "blank";
                            }
                            else
