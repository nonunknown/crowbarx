...
namespace Crowbar
{
    public class SourceMdlAnimationDesc52 : SourceMdlAnimationDescBase
    {
        public SourceMdlAnimationDesc52()
        {
        ...
        public List<SourceAniFrameAnim52> theSectionsOfFrameAnim;
