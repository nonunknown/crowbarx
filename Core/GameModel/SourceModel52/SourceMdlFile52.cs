...
namespace Crowbar
{
    public class SourceMdlFile52
    {
        ...
        public SourceMdlFile52(BinaryReader mdlFileReader, SourceMdlFileData52 mdlFileData)
        {
        ...
        public SourceMdlFile52(BinaryWriter mdlFileWriter, SourceMdlFileData52 mdlFileData)
        {
        ...
        public void ReadMdlHeader00(string logDescription)
        {
            ...
            {
                theMdlFileData.theFileSeekLog.Add(fileOffsetStart, fileOffsetEnd, logDescription + " (Actual version: " + theMdlFileData.version.ToString() + "; override version: 52)");
            }
        }
        ...
        public void ReadMdlHeader01(string logDescription)
        {
            ...
            if (theMdlFileData.surfacePropOffset > 0)
            {
                ...
                fileOffsetEnd2 = theInputFileReader.BaseStream.Position - 1L;
            ...
            if (theMdlFileData.animBlockCount > 0)
            {
                ...
                if (theMdlFileData.animBlockOffset > 0)
                {
                    ...
                    for (int offset = 0, loopTo = theMdlFileData.animBlockCount - 1; offset <= loopTo; offset++)
                    {
                        var anAnimBlock = new SourceMdlAnimBlock();
        ...
        public void ReadMdlHeader02(string logDescription)
        {
            ...
            theMdlFileData.illumPositionAttachmentIndex = theInputFileReader.ReadInt32();
        ...
        public void ReadBones()
        {
            if (theMdlFileData.boneCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.boneCount - 1; i <= loopTo; i++)
                    {
                        boneInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                        var aBone = new SourceMdlBone();
                        ...
                        // ------
                        for (int j = 0, loopTo1 = aBone.boneControllerIndex.Length - 1; j <= loopTo1; j++)
        ...
        {
            long axisInterpBoneInputFileStreamPosition;
            long inputFileStreamPosition;
            long fileOffsetStart;
            long fileOffsetEnd;
            try
            {
                ...
                for (int x = 0, loopTo = aBone.theAxisInterpBone.pos.Length - 1; x <= loopTo; x++)
                {
                ...
                for (int x = 0, loopTo1 = aBone.theAxisInterpBone.quat.Length - 1; x <= loopTo1; x++)
                {
        ...
        {
            long quatInterpBoneInputFileStreamPosition;
            long inputFileStreamPosition;
            long fileOffsetStart;
            long fileOffsetEnd;
            try
        ...
        private void ReadTriggers(long quatInterpBoneInputFileStreamPosition, SourceMdlQuatInterpBone aQuatInterpBone)
        {
            ...
            try
            {
                ...
                for (int j = 0, loopTo = aQuatInterpBone.triggerCount - 1; j <= loopTo; j++)
                {
                    var aTrigger = new SourceMdlQuatInterpBoneInfo();
        ...
        public void ReadBoneControllers()
        {
            ...
            {
                long boneControllerInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                ...
                for (int i = 0, loopTo = theMdlFileData.boneControllerCount - 1; i <= loopTo; i++)
                {
                    boneControllerInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var aBoneController = new SourceMdlBoneController();
                    ...
                    {
                        for (int x = 0, loopTo1 = aBoneController.unused.Length - 1; x <= loopTo1; x++)
        ...
        public void ReadAttachments()
        {
            ...
            {
                long attachmentInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                for (int i = 0, loopTo = theMdlFileData.localAttachmentCount - 1; i <= loopTo; i++)
                {
                    attachmentInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var anAttachment = new SourceMdlAttachment();
                    if (theMdlFileData.version == 10)
                    {
        ...
        public void ReadHitboxSets()
        {
            ...
            {
                long hitboxSetInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                for (int i = 0, loopTo = theMdlFileData.hitboxSetCount - 1; i <= loopTo; i++)
                {
                    hitboxSetInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var aHitboxSet = new SourceMdlHitboxSet();
        ...
        private void ReadHitboxes(long hitboxOffsetInputFileStreamPosition, SourceMdlHitboxSet aHitboxSet)
        {
            ...
            {
                long hitboxInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                for (int j = 0, loopTo = aHitboxSet.hitboxCount - 1; j <= loopTo; j++)
                {
                    hitboxInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var aHitbox = new SourceMdlHitbox();
        ...
        {
            if (theMdlFileData.boneTableByNameOffset != 0 && theMdlFileData.theBones is object)
            {
                long fileOffsetStart;
                long fileOffsetEnd;
        ...
        {
            long animInputFileStreamPosition;
            long inputFileStreamPosition;
            long fileOffsetStart;
            long fileOffsetEnd;
            ...
            for (int i = 0, loopTo = theMdlFileData.localAnimationCount - 1; i <= loopTo; i++)
            {
                animInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                var anAnimationDesc = new SourceMdlAnimationDesc52();
                ...
                for (int x = 0, loopTo1 = anAnimationDesc.unused1.Length - 1; x <= loopTo1; x++)
            ...
            if (theMdlFileData.theAnimationDescs is object)
            {
                foreach (SourceMdlAnimationDesc52 anAnimationDesc in theMdlFileData.theAnimationDescs)
                {
                    if (anAnimationDesc.sectionOffset != 0 && anAnimationDesc.sectionFrameCount > 0)
                    {
                        ...
                        sectionCount = (int)Math.Round(Math.Truncate(anAnimationDesc.frameCount / (double)anAnimationDesc.sectionFrameCount)) + 2;
                        long offset;
                        ...
                        for (int sectionIndex = 0, loopTo = sectionCount - 1; sectionIndex <= loopTo; sectionIndex++)
        ...
        public void ReadAnimationMdlBlocks()
        {
            if (theMdlFileData.theAnimationDescs is object)
            {
                ...
                for (int anAnimDescIndex = 0, loopTo = theMdlFileData.theAnimationDescs.Count - 1; anAnimDescIndex <= loopTo; anAnimDescIndex++)
                {
                    ...
                    if (theMdlFileData.theFirstAnimationDesc is null && Conversions.ToString(anAnimationDesc.theName[0]) != "@")
                    {
                    ...
                    if ((anAnimationDesc.flags & SourceMdlAnimationDesc.STUDIO_FRAMEANIM) != 0)
                    {
                        ...
                        if (anAnimationDesc.sectionOffset != 0 && anAnimationDesc.sectionFrameCount > 0)
                        {
                            ...
                            for (sectionIndex = 1; sectionIndex <= loopTo1; sectionIndex++)
                            {
                                aSectionOfFrameAnimation = new SourceAniFrameAnim52();
                                anAnimationDesc.theSectionsOfFrameAnim.Add(aSectionOfFrameAnimation);
                            }
                            ...
                            {
                                var loopTo2 = sectionCount - 1;
                                for (sectionIndex = 0; sectionIndex <= loopTo2; sectionIndex++)
                                {
                    ...
                    else
                    {
                        ...
                        if (anAnimationDesc.sectionOffset != 0 && anAnimationDesc.sectionFrameCount > 0)
                        {
                            ...
                            // NOTE: First sectionOfAnimation was created above.
                            for (int sectionIndex = 1, loopTo3 = sectionCount - 1; sectionIndex <= loopTo3; sectionIndex++)
                            {
                                aSectionOfAnimation = new List<SourceMdlAnimation>();
                                anAnimationDesc.theSectionsOfAnimations.Add(aSectionOfAnimation);
                            }

                            long adjustedAnimOffset;
                            if (anAnimationDesc.animBlock == 0)
                            {
                                for (int sectionIndex = 0, loopTo4 = sectionCount - 1; sectionIndex <= loopTo4; sectionIndex++)
                                {
                                    if (anAnimationDesc.theSections[sectionIndex].animBlock == 0)
                                    {
                                        ...
                                        ReadMdlAnimation(animInputFileStreamPosition + adjustedAnimOffset, anAnimationDesc, sectionFrameCount, aSectionOfAnimation, sectionIndex >= sectionCount - 2 | anAnimationDesc.frameCount == (sectionIndex + 1) * anAnimationDesc.sectionFrameCount);
                                    }
                                }
                            }
                        }
        ...
        {
            long fileOffsetStart;
            long fileOffsetEnd = 0L;

            // The data seems to be copy of first several anim frames in the ANI file.
            if (anAnimationDesc.spanFrameCount != 0 || anAnimationDesc.spanCount != 0 || anAnimationDesc.spanOffset != 0 || anAnimationDesc.spanStallTime != 0f)
            {
                ...
                fileOffsetEnd = animInputFileStreamPosition + anAnimationDesc.spanOffset - 1L;
                SourceMdlBone aBone;
        ...
        protected void ReadAnimationFrameByBone(long animInputFileStreamPosition, SourceMdlAnimationDesc52 anAnimationDesc, int sectionFrameCount, int sectionIndex, bool lastSectionIsBeingRead)
        {
            ...
            long animFrameInputFileStreamPosition;
            long boneFrameDataStartInputFileStreamPosition;
            long fileOffsetStart;
            long fileOffsetEnd;
            int boneCount;
            byte boneFlag;
            BoneConstantInfo49 aBoneConstantInfo;
            List<BoneFrameDataInfo49> aBoneFrameDataInfoList;
            ...
            try
            {
                ...
                for (int x = 0, loopTo = aSectionOfAnimation.unused.Length - 1; x <= loopTo; x++)
                ...
                for (int boneIndex = 0, loopTo1 = boneCount - 1; boneIndex <= loopTo1; boneIndex++)
                {
                ...
                if (aSectionOfAnimation.constantsOffset != 0)
                {
                    ...
                    for (int boneIndex = 0, loopTo2 = boneCount - 1; boneIndex <= loopTo2; boneIndex++)
                    {
                ...
                if (aSectionOfAnimation.frameLength > 0 && aSectionOfAnimation.frameOffset != 0)
                {
                    ...
                    for (int frameIndex = 0, loopTo3 = adjustedFrameCount - 1; frameIndex <= loopTo3; frameIndex++)
                    {
                        ...
                        for (int boneIndex = 0, loopTo4 = boneCount - 1; boneIndex <= loopTo4; boneIndex++)
                        {
        ...
        protected void ReadMdlAnimation(long animInputFileStreamPosition, SourceMdlAnimationDesc52 anAnimationDesc, int sectionFrameCount, List<SourceMdlAnimation> aSectionOfAnimation, bool lastSectionIsBeingRead)
        {
            ...
            long nextAnimationInputFileStreamPosition;
            long animValuePointerInputFileStreamPosition;
            var rotValuePointerInputFileStreamPosition = default(long);
            var posValuePointerInputFileStreamPosition = default(long);
            long fileOffsetStart;
            var fileOffsetEnd = default(long);
            SourceMdlAnimation anAnimation;
            int boneCount;
            var boneIndex = default(byte);
            theInputFileReader.BaseStream.Seek(animInputFileStreamPosition, SeekOrigin.Begin);
            ...
            for (int j = 0, loopTo = boneCount - 1; j <= loopTo; j++)
            {
                ...
                if ((anAnimation.flags & SourceMdlAnimation.STUDIO_ANIM_ANIMROT) > 0)
                {
                    ...
                    if (anAnimation.theRotV.theAnimXValues is null)
                    {
                    ...
                    if (anAnimation.theRotV.theAnimYValues is null)
                    {
                    ...
                    if (anAnimation.theRotV.theAnimZValues is null)
                    {
                ...
                if ((anAnimation.flags & SourceMdlAnimation.STUDIO_ANIM_ANIMPOS) > 0)
                {
                    ...
                    if (anAnimation.thePosV.theAnimXValues is null)
                    {
                    ...
                    if (anAnimation.thePosV.theAnimYValues is null)
                    {
                    ...
                    if (anAnimation.thePosV.theAnimZValues is null)
                    {
                        anAnimation.thePosV.theAnimZValues = new List<SourceMdlAnimationValue>();
                    }
                }

                theMdlFileData.theFileSeekLog.Add(animationInputFileStreamPosition, theInputFileReader.BaseStream.Position - 1L, "anAnimationDesc.anAnimation (frameCount = " + anAnimationDesc.frameCount.ToString() + "; sectionFrameCount = " + sectionFrameCount.ToString() + ")");
        ...
        private void ReadMdlAnimValues(long animValuesInputFileStreamPosition, int frameCount, bool lastSectionIsBeingRead, List<SourceMdlAnimationValue> theAnimValues, string debugDescription)
        {
            ...
            var animValue = new SourceMdlAnimationValue();
            byte currentTotal;
            byte validCount;
        ...
        protected long ReadMdlIkRules(long animInputFileStreamPosition, SourceMdlAnimationDesc52 anAnimationDesc)
        {
            if (anAnimationDesc.ikRuleCount > 0)
            {
                long ikRuleInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                long fileOffsetEnd2;
                long fileOffsetEndOfIkRuleExtraData;
                long fileOffsetOfLastEndOfIkRuleExtraData;
                ...
                fileOffsetStart = theInputFileReader.BaseStream.Position;
                fileOffsetOfLastEndOfIkRuleExtraData = 0L;
                anAnimationDesc.theIkRules = new List<SourceMdlIkRule>(anAnimationDesc.ikRuleCount);
                for (int ikRuleIndex = 0, loopTo = anAnimationDesc.ikRuleCount - 1; ikRuleIndex <= loopTo; ikRuleIndex++)
                {
                    ikRuleInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var anIkRule = new SourceMdlIkRule();
                    ...
                    for (int x = 0, loopTo1 = anIkRule.unused.Length - 1; x <= loopTo1; x++)
                        anIkRule.unused[x] = theInputFileReader.ReadInt32();
                    anAnimationDesc.theIkRules.Add(anIkRule);
                    inputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    fileOffsetEndOfIkRuleExtraData = 0L;
                    ...
                    {
                        long compressedIkErrorsEndOffset;
                        compressedIkErrorsEndOffset = ReadCompressedIkErrors(ikRuleInputFileStreamPosition, ikRuleIndex, anAnimationDesc);
                    ...
                    if (fileOffsetEndOfIkRuleExtraData > 0L)
                    {
                        ...
                        fileOffsetOfLastEndOfIkRuleExtraData = theInputFileReader.BaseStream.Position - 1L;
                    }
                ...
                if (fileOffsetOfLastEndOfIkRuleExtraData > 0L)
                {
                    return fileOffsetOfLastEndOfIkRuleExtraData;
                }
                else
                {
                    return theInputFileReader.BaseStream.Position - 1L;
                }
            }
        ...
        {
            SourceMdlIkRule anIkRule;
            anIkRule = anAnimationDesc.theIkRules[ikRuleIndex];
            long compressedIkErrorInputFileStreamPosition;
            long kInputFileStreamPosition;
            ...
            for (int k = 0, loopTo = anIkRule.theCompressedIkError.scale.Length - 1; k <= loopTo; k++)
            {
            ...
            for (int k = 0, loopTo1 = anIkRule.theCompressedIkError.offset.Length - 1; k <= loopTo1; k++)
            {
                kInputFileStreamPosition = theInputFileReader.BaseStream.Position;
            ...
            for (int k = 0, loopTo2 = anIkRule.theCompressedIkError.scale.Length - 1; k <= loopTo2; k++)
            {
        ...
        protected void ReadMdlAnimationSection(long animInputFileStreamPosition, SourceMdlAnimationDesc52 anAnimationDesc, FileSeekLog aFileSeekLog)
        {
            ...
            try
            {
                ...
                var anAnimSection = new SourceMdlAnimationSection();
                ...
                if (theMdlFileData.theAnimBlocks is null)
                {
        ...
        protected long ReadMdlMovements(long animInputFileStreamPosition, SourceMdlAnimationDesc52 anAnimationDesc)
        {
            if (anAnimationDesc.movementCount > 0)
            {
                long movementInputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                ...
                for (int j = 0, loopTo = anAnimationDesc.movementCount - 1; j <= loopTo; j++)
                {
                    movementInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var aMovement = new SourceMdlMovement();
        ...
        protected long ReadLocalHierarchies(long animInputFileStreamPosition, SourceMdlAnimationDesc52 anAnimationDesc)
        {
            if (anAnimationDesc.localHierarchyCount > 0)
            {
                long localHieararchyInputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                ...
                for (int j = 0, loopTo = anAnimationDesc.localHierarchyCount - 1; j <= loopTo; j++)
                {
                    localHieararchyInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var aLocalHierarchy = new SourceMdlLocalHierarchy();
                    ...
                    for (int x = 0, loopTo1 = aLocalHierarchy.unused.Length - 1; x <= loopTo1; x++)
        ...
        public void ReadSequenceDescs()
        {
            ...
            {
                long seqInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theMdlFileData.localSequenceCount - 1; i <= loopTo; i++)
                    {
                        seqInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                        var aSeqDesc = new SourceMdlSequenceDesc();
        ...
        private void ReadPoseKeys(long seqInputFileStreamPosition, SourceMdlSequenceDesc aSeqDesc)
        {
            ...
            long poseKeyInputFileStreamPosition;
            // Dim inputFileStreamPosition As Long
            long fileOffsetStart;
            long fileOffsetEnd;
            ...
            for (int j = 0, loopTo = poseKeyCount - 1; j <= loopTo; j++)
            {
                poseKeyInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                double aPoseKey;
                aPoseKey = theInputFileReader.ReadSingle();
        ...
        private void ReadEvents(long seqInputFileStreamPosition, SourceMdlSequenceDesc aSeqDesc)
        {
            ...
            long eventInputFileStreamPosition;
            long inputFileStreamPosition;
            long fileOffsetStart;
            long fileOffsetEnd;
            long fileOffsetStart2;
            ...
            for (int j = 0, loopTo = eventCount - 1; j <= loopTo; j++)
            {
                eventInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                var anEvent = new SourceMdlEvent();
                ...
                for (int x = 0, loopTo1 = anEvent.options.Length - 1; x <= loopTo1; x++)
        ...
        private void ReadAutoLayers(long seqInputFileStreamPosition, SourceMdlSequenceDesc aSeqDesc)
        {
            ...
            long autoLayerInputFileStreamPosition;
            // Dim inputFileStreamPosition As Long
            long fileOffsetStart;
            long fileOffsetEnd;
            ...
            for (int j = 0, loopTo = autoLayerCount - 1; j <= loopTo; j++)
            {
                autoLayerInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                var anAutoLayer = new SourceMdlAutoLayer();
        ...
        {
            long weightListInputFileStreamPosition;
            // Dim inputFileStreamPosition As Long
            long fileOffsetStart;
            long fileOffsetEnd;
            // Dim fileOffsetStart2 As Long
            ...
            for (int j = 0, loopTo = theMdlFileData.boneCount - 1; j <= loopTo; j++)
            {
                weightListInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                double anAnimBoneWeight;
                anAnimBoneWeight = theInputFileReader.ReadSingle();
                aSeqDesc.theBoneWeights.Add(anAnimBoneWeight);
                if (anAnimBoneWeight != 1d)
                {
        ...
        private void ReadSequenceIkLocks(long seqInputFileStreamPosition, SourceMdlSequenceDesc aSeqDesc)
        {
            ...
            long lockInputFileStreamPosition;
            // Dim inputFileStreamPosition As Long
            long fileOffsetStart;
            long fileOffsetEnd;
            ...
            for (int j = 0, loopTo = lockCount - 1; j <= loopTo; j++)
            {
                lockInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                var anIkLock = new SourceMdlIkLock();
                ...
                for (int x = 0, loopTo1 = anIkLock.unused.Length - 1; x <= loopTo1; x++)
        ...
        private void ReadMdlAnimIndexes(long seqInputFileStreamPosition, SourceMdlSequenceDesc aSeqDesc)
        {
            ...
            long animIndexInputFileStreamPosition;
            // Dim inputFileStreamPosition As Long
            long fileOffsetStart;
            long fileOffsetEnd;
            ...
            for (int j = 0, loopTo = animIndexCount - 1; j <= loopTo; j++)
            {
                animIndexInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                short anAnimIndex;
                anAnimIndex = theInputFileReader.ReadInt16();
                aSeqDesc.theAnimDescIndexes.Add(anAnimIndex);
                if (theMdlFileData.theAnimationDescs is object && theMdlFileData.theAnimationDescs.Count > anAnimIndex)
                {
        ...
        private void ReadActivityModifiers(long seqInputFileStreamPosition, SourceMdlSequenceDesc aSeqDesc)
        {
            ...
            long activityModifierInputFileStreamPosition;
            long inputFileStreamPosition;
            long fileOffsetStart;
            long fileOffsetEnd;
            long fileOffsetStart2;
            ...
            for (int j = 0, loopTo = activityModifierCount - 1; j <= loopTo; j++)
            {
                activityModifierInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                var anActivityModifier = new SourceMdlActivityModifier();
        ...
        public void ReadLocalNodeNames()
        {
            ...
            {
                long localNodeNameInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                for (int i = 0, loopTo = theMdlFileData.localNodeCount - 1; i <= loopTo; i++)
                {
                    localNodeNameInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    string aLocalNodeName;
        ...
        public void ReadLocalNodes()
        {
            ...
            if (theMdlFileData.localNodeCount > 0 && theMdlFileData.localNodeOffset != 0)
            {
                ...
                for (int i = 0, loopTo = theMdlFileData.localNodeCount - 1; i <= loopTo; i++)
                {
                    var exitNodes = new List<byte>(theMdlFileData.localNodeCount);
                    for (int j = 0, loopTo1 = theMdlFileData.localNodeCount - 1; j <= loopTo1; j++)
                    {
                        byte nodeValue;
                        nodeValue = theInputFileReader.ReadByte();
        ...
        public void ReadBodyParts()
        {
            if (theMdlFileData.bodyPartCount > 0)
            {
                ...
                for (int bodyPartIndex = 0, loopTo = theMdlFileData.bodyPartCount - 1; bodyPartIndex <= loopTo; bodyPartIndex++)
                {
                    ...
                    var aBodyPart = new SourceMdlBodyPart();
                    ...
                    {
                        theMdlFileData.theFileSeekLog.LogToEndAndAlignToNextStart(theInputFileReader, theInputFileReader.BaseStream.Position - 1L, 4, "theMdlFileData.theBodyParts + aBodyPart.theModels alignment");
                    }
        ...
        private void ReadModels(long bodyPartInputFileStreamPosition, SourceMdlBodyPart aBodyPart, int bodyPartIndex)
        {
            if (aBodyPart.modelCount > 0)
            {
                ...
                for (int j = 0, loopTo = aBodyPart.modelCount - 1; j <= loopTo; j++)
                {
                    modelInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var aModel = new SourceMdlModel();
                    ...
                    var modelVertexData = new SourceMdlModelVertexData();
        ...
        private void ReadMeshes(long modelInputFileStreamPosition, SourceMdlModel aModel)
        {
            if (aModel.meshCount > 0 && aModel.meshOffset != 0)
            {
                ...
                for (int meshIndex = 0, loopTo = aModel.meshCount - 1; meshIndex <= loopTo; meshIndex++)
                {
                    ...
                    var meshVertexData = new SourceMdlMeshVertexData();
                    meshVertexData.modelVertexDataP = theInputFileReader.ReadInt32();
                    for (int x = 0, loopTo1 = SourceConstants.MAX_NUM_LODS - 1; x <= loopTo1; x++)
        ...
        private void ReadEyeballs(long modelInputFileStreamPosition, SourceMdlModel aModel, int bodyPartIndex)
        {
            if (aModel.eyeballCount > 0 && aModel.eyeballOffset != 0)
            {
                ...
                long eyeballInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                fileOffsetStart = theInputFileReader.BaseStream.Position;
                for (int k = 0, loopTo = aModel.eyeballCount - 1; k <= loopTo; k++)
                {
                    eyeballInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var anEyeball = new SourceMdlEyeball();
                    ...
                    for (int x = 0, loopTo1 = anEyeball.unused.Length - 1; x <= loopTo1; x++)
                        anEyeball.unused[x] = theInputFileReader.ReadInt32();
                    anEyeball.eyeballIsNonFacs = theInputFileReader.ReadByte();
                    for (int x = 0, loopTo2 = anEyeball.unused3.Length - 1; x <= loopTo2; x++)
                        anEyeball.unused3[x] = theInputFileReader.ReadChar();
                    for (int x = 0, loopTo3 = anEyeball.unused4.Length - 1; x <= loopTo3; x++)
        ...
        private void ReadFlexes(long meshInputFileStreamPosition, SourceMdlMesh aMesh)
        {
            ...
            long flexInputFileStreamPosition;
            long inputFileStreamPosition;
            long fileOffsetStart;
            long fileOffsetEnd;
            // Dim fileOffsetStart2 As Long
            ...
            fileOffsetStart = theInputFileReader.BaseStream.Position;
            for (int k = 0, loopTo = aMesh.flexCount - 1; k <= loopTo; k++)
            {
                flexInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                var aFlex = new SourceMdlFlex();
                ...
                for (int x = 0, loopTo1 = aFlex.unusedChar.Length - 1; x <= loopTo1; x++)
                    aFlex.unusedChar[x] = theInputFileReader.ReadChar();
                for (int x = 0, loopTo2 = aFlex.unused.Length - 1; x <= loopTo2; x++)
        ...
        private void ReadVertAnims(long flexInputFileStreamPosition, SourceMdlFlex aFlex)
        {
            ...
            for (int k = 0, loopTo = aFlex.vertCount - 1; k <= loopTo; k++)
            {
                eyeballInputFileStreamPosition = theInputFileReader.BaseStream.Position;
        ...
        public void ReadFlexDescs()
        {
            ...
            {
                long flexDescInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                for (int i = 0, loopTo = theMdlFileData.flexDescCount - 1; i <= loopTo; i++)
                {
                    flexDescInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var aFlexDesc = new SourceMdlFlexDesc();
        ...
        public void ReadFlexControllers()
        {
            ...
            {
                long flexControllerInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                for (int i = 0, loopTo = theMdlFileData.flexControllerCount - 1; i <= loopTo; i++)
                {
                    flexControllerInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var aFlexController = new SourceMdlFlexController();
        ...
        public void ReadFlexRules()
        {
            ...
            {
                long flexRuleInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                // Dim fileOffsetStart2 As Long
                ...
                for (int i = 0, loopTo = theMdlFileData.flexRuleCount - 1; i <= loopTo; i++)
                {
                    flexRuleInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var aFlexRule = new SourceMdlFlexRule();
        ...
        private void ReadFlexOps(long flexRuleInputFileStreamPosition, SourceMdlFlexRule aFlexRule)
        {
            ...
            for (int i = 0, loopTo = aFlexRule.opCount - 1; i <= loopTo; i++)
            {
                // flexRuleInputFileStreamPosition = Me.theInputFileReader.BaseStream.Position
                var aFlexOp = new SourceMdlFlexOp();
        ...
        public void ReadIkChains()
        {
            ...
            {
                long ikChainInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                for (int i = 0, loopTo = theMdlFileData.ikChainCount - 1; i <= loopTo; i++)
                {
                    ikChainInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var anIkChain = new SourceMdlIkChain();
        ...
        private void ReadIkLinks(long ikChainInputFileStreamPosition, SourceMdlIkChain anIkChain)
        {
            if (anIkChain.linkCount > 0)
            {
                ...
                for (int j = 0, loopTo = anIkChain.linkCount - 1; j <= loopTo; j++)
                {
                    // ikLinkInputFileStreamPosition = Me.theInputFileReader.BaseStream.Position
                    var anIkLink = new SourceMdlIkLink();
        ...
        public void ReadIkLocks()
        {
            if (theMdlFileData.localIkAutoPlayLockCount > 0)
            {
                ...
                for (int i = 0, loopTo = theMdlFileData.localIkAutoPlayLockCount - 1; i <= loopTo; i++)
                {
        ...
        public void ReadMouths()
        {
            if (theMdlFileData.mouthCount > 0)
            {
                ...
                for (int i = 0, loopTo = theMdlFileData.mouthCount - 1; i <= loopTo; i++)
                {
                    // mouthInputFileStreamPosition = Me.theInputFileReader.BaseStream.Position
                    var aMouth = new SourceMdlMouth();
        ...
        public void ReadPoseParamDescs()
        {
            ...
            {
                long poseInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                for (int i = 0, loopTo = theMdlFileData.localPoseParamaterCount - 1; i <= loopTo; i++)
                {
                    poseInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var aPoseParamDesc = new SourceMdlPoseParamDesc();
        ...
        public void ReadTextures()
        {
            ...
            {
                long textureInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                for (int i = 0, loopTo = theMdlFileData.textureCount - 1; i <= loopTo; i++)
                {
                    textureInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var aTexture = new SourceMdlTexture();
        ...
        public void ReadTexturePaths()
        {
            ...
            {
                long texturePathInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                for (int i = 0, loopTo = theMdlFileData.texturePathCount - 1; i <= loopTo; i++)
                {
        ...
        public void ReadSkinFamilies()
        {
            ...
            {
                long skinFamilyInputFileStreamPosition;
                // Dim inputFileStreamPosition As Long
                long fileOffsetStart;
                long fileOffsetEnd;
                // Dim fileOffsetStart2 As Long
                ...
                for (int i = 0, loopTo = theMdlFileData.skinFamilyCount - 1; i <= loopTo; i++)
                {
                    skinFamilyInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var aSkinFamily = new List<short>();
                    for (int j = 0, loopTo1 = theMdlFileData.skinReferenceCount - 1; j <= loopTo1; j++)
                    {
                        short aSkinRef;
        ...
        public void ReadModelGroups()
        {
            ...
            {
                long includeModelInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                for (int i = 0, loopTo = theMdlFileData.includeModelCount - 1; i <= loopTo; i++)
                {
                    includeModelInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var aModelGroup = new SourceMdlModelGroup();
        ...
        public void ReadFlexControllerUis()
        {
            ...
            {
                long flexControllerUiInputFileStreamPosition;
                long inputFileStreamPosition;
                long fileOffsetStart;
                long fileOffsetEnd;
                long fileOffsetStart2;
                ...
                for (int i = 0, loopTo = theMdlFileData.flexControllerUiCount - 1; i <= loopTo; i++)
                {
                    flexControllerUiInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var aFlexControllerUi = new SourceMdlFlexControllerUi();
                    ...
                    for (int x = 0, loopTo1 = aFlexControllerUi.unused.Length - 1; x <= loopTo1; x++)
        ...
        public void ReadKeyValues()
        {
            if (theMdlFileData.keyValueSize > 0)
            {
                ...
                theMdlFileData.theKeyValuesText = Conversions.ToString(theInputFileReader.ReadChars(theMdlFileData.keyValueSize - 1));
        ...
        public void ReadBoneTransforms()
        {
            if (theMdlFileData.sourceBoneTransformCount > 0)
            {
                ...
                for (int i = 0, loopTo = theMdlFileData.sourceBoneTransformCount - 1; i <= loopTo; i++)
                {
                    boneInputFileStreamPosition = theInputFileReader.BaseStream.Position;
                    var aBoneTransform = new SourceMdlBoneTransform();
                    ...
                    else if (aBoneTransform.theName is null)
                    {
        ...
        public void ReadLinearBoneTable()
        {
            if (theMdlFileData.linearBoneOffset > 0)
            {
                try
                {
                    long boneTableInputFileStreamPosition;
                    // Dim inputFileStreamPosition As Long
                    long fileOffsetStart;
                    long fileOffsetEnd;
                    long fileOffsetStart2;
                    ...
                    SourceMdlLinearBone linearBoneTable;
                    ...
                    for (int x = 0, loopTo = linearBoneTable.unused.Length - 1; x <= loopTo; x++)
                    ...
                    fileOffsetStart2 = theInputFileReader.BaseStream.Position;
                    for (int i = 0, loopTo1 = linearBoneTable.boneCount - 1; i <= loopTo1; i++)
                    {
                        int flags;
                        flags = theInputFileReader.ReadInt32();
                    ...
                    fileOffsetStart2 = theInputFileReader.BaseStream.Position;
                    for (int i = 0, loopTo2 = linearBoneTable.boneCount - 1; i <= loopTo2; i++)
                    {
                        int parent;
                        parent = theInputFileReader.ReadInt32();
                    ...
                    fileOffsetStart2 = theInputFileReader.BaseStream.Position;
                    for (int i = 0, loopTo3 = linearBoneTable.boneCount - 1; i <= loopTo3; i++)
                    {
                    ...
                    fileOffsetStart2 = theInputFileReader.BaseStream.Position;
                    for (int i = 0, loopTo4 = linearBoneTable.boneCount - 1; i <= loopTo4; i++)
                    {
                        var quaternion = new SourceQuaternion();
                    ...
                    fileOffsetStart2 = theInputFileReader.BaseStream.Position;
                    for (int i = 0, loopTo5 = linearBoneTable.boneCount - 1; i <= loopTo5; i++)
                    {
                    ...
                    fileOffsetStart2 = theInputFileReader.BaseStream.Position;
                    for (int i = 0, loopTo6 = linearBoneTable.boneCount - 1; i <= loopTo6; i++)
                    {
                        var poseToBoneDataColumn0 = new SourceVector();
                        var poseToBoneDataColumn1 = new SourceVector();
                        var poseToBoneDataColumn2 = new SourceVector();
                        var poseToBoneDataColumn3 = new SourceVector();
                    ...
                    fileOffsetStart2 = theInputFileReader.BaseStream.Position;
                    for (int i = 0, loopTo7 = linearBoneTable.boneCount - 1; i <= loopTo7; i++)
                    {
                        var positionScale = new SourceVector();
                    ...
                    fileOffsetStart2 = theInputFileReader.BaseStream.Position;
                    for (int i = 0, loopTo8 = linearBoneTable.boneCount - 1; i <= loopTo8; i++)
                    {
                        var rotationScale = new SourceVector();
                    ...
                    fileOffsetStart2 = theInputFileReader.BaseStream.Position;
                    for (int i = 0, loopTo9 = linearBoneTable.boneCount - 1; i <= loopTo9; i++)
                    {
                        var qAlignment = new SourceQuaternion();
        ...
        public void CreateFlexFrameList()
        {
            ...
            if (theMdlFileData.theFlexDescs is object && theMdlFileData.theFlexDescs.Count > 0)
            {
                // Dim flexDescToMeshIndexes As List(Of List(Of Integer))
                List<List<FlexFrame>> flexDescToFlexFrames;
                ...
                for (int x = 0, loopTo = theMdlFileData.theFlexDescs.Count - 1; x <= loopTo; x++)
                {
                    var flexFrameList = new List<FlexFrame>();
                    flexDescToFlexFrames.Add(flexFrameList);
                }

                for (int bodyPartIndex = 0, loopTo1 = theMdlFileData.theBodyParts.Count - 1; bodyPartIndex <= loopTo1; bodyPartIndex++)
                {
                    aBodyPart = theMdlFileData.theBodyParts[bodyPartIndex];
                    if (aBodyPart.theModels is object && aBodyPart.theModels.Count > 0)
                    {
                        for (int modelIndex = 0, loopTo2 = aBodyPart.theModels.Count - 1; modelIndex <= loopTo2; modelIndex++)
                        {
                            aModel = aBodyPart.theModels[modelIndex];
                            if (aModel.theMeshes is object && aModel.theMeshes.Count > 0)
                            {
                                for (int meshIndex = 0, loopTo3 = aModel.theMeshes.Count - 1; meshIndex <= loopTo3; meshIndex++)
                                {
                                    ...
                                    if (aMesh.theFlexes is object && aMesh.theFlexes.Count > 0)
                                    {
                                        for (int flexIndex = 0, loopTo4 = aMesh.theFlexes.Count - 1; flexIndex <= loopTo4; flexIndex++)
                                        {
                                            aFlex = aMesh.theFlexes[flexIndex];
                                            aFlexFrame = null;
                                            if (flexDescToFlexFrames[aFlex.flexDescIndex] is object)
                                            {
                                                for (int x = 0, loopTo5 = flexDescToFlexFrames[aFlex.flexDescIndex].Count - 1; x <= loopTo5; x++)
                                                {
        ...
        {
            theOutputFileWriter.BaseStream.Seek(0xCL, SeekOrigin.Begin);
        ...
        public void WriteInternalMdlFileNameCopy(string internalMdlFileNameCopy)
        {
            if (theMdlFileData.nameCopyOffset > 0)
            {
                ...
                theOutputFileWriter.BaseStream.Seek(0L, SeekOrigin.End);
                // NOTE: Important that offset be an Integer (4 bytes) rather than a Long (8 bytes).
                int offset;
                offset = (int)theOutputFileWriter.BaseStream.Position - 0x198;
                theOutputFileWriter.BaseStream.Seek(0x1ACL, SeekOrigin.Begin);
                ...
                theOutputFileWriter.BaseStream.Seek(0x4CL, SeekOrigin.Begin);
                theOutputFileWriter.Write(offset);
            }
        }
        ...
        public void WriteInternalAniFileName(string internalAniFileName)
        {
            if (theMdlFileData.animBlockCount > 0)
            {
                if (theMdlFileData.animBlockNameOffset > 0)
                {
                    ...
                    int offset;
                    offset = (int)theOutputFileWriter.BaseStream.Position;
                    theOutputFileWriter.BaseStream.Seek(0x15CL, SeekOrigin.Begin);
                    theOutputFileWriter.Write(offset);
        ...
        private int FindFlexFrameIndex(List<FlexFrame> flexFrames, string flexName, int eyelidPartIndex)
        {
            ...
            for (int i = 0, loopTo = flexFrames.Count - 1; i <= loopTo; i++)
            {
        ...
        protected SourceMdlFileData52 theMdlFileData;
