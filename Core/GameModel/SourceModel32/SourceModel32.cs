    ...
    public class SourceModel32 : SourceModel31
    {
        ...
        public AppEnums.StatusMessage WriteMeshSmdFile(string smdPathFileName, int lodIndex, SourceVtxModel06 aVtxModel, SourceMdlModel37 aModel, int bodyPartVertexIndexStart)
        {
            ...
            try
            {
                ...
                var smdFile = new SourceSmdFile32(theOutputFileTextWriter, theMdlFileData);
        ...
        protected override void ReadMdlFileHeader_Internal()
        {
            ...
            var mdlFile = new SourceMdlFile32(theInputFileReader, theMdlFileData);
        ...
        {
            var qcFile = new SourceQcFile32(theOutputFileTextWriter, theQcPathFileName, theMdlFileData, thePhyFileDataGeneric, theVtxFileData, theName);
            try
            {
        ...
        {
            var physicsMeshSmdFile = new SourceSmdFile32(theOutputFileTextWriter, theMdlFileData, thePhyFileDataGeneric);
            try
            {
