...
namespace Crowbar
{
    public class SourceMdlFile32
    {
        ...
        public SourceMdlFile32(BinaryReader mdlFileReader, SourceMdlFileData32 mdlFileData)
        {
        ...
        public SourceMdlFile32(BinaryWriter mdlFileWriter, SourceMdlFileData32 mdlFileData)
        {
        ...
        public void ReadMdlHeader00(string logDescription)
        {
            ...
            {
                theMdlFileData.theFileSeekLog.Add(fileOffsetStart, fileOffsetEnd, logDescription + " (Actual version: " + theMdlFileData.version.ToString() + "; override version: 32)");
            }
        }
        ...
        public void ReadBoneControllers()
        {
            if (theMdlFileData.boneControllerCount > 0)
            {
                ...
                try
                {
                    ...
                    fileOffsetStart = theInputFileReader.BaseStream.Position;
                    theMdlFileData.theBoneControllers = new List<SourceMdlBoneController32>(theMdlFileData.boneControllerCount);
                    for (int i = 0, loopTo = theMdlFileData.boneControllerCount - 1; i <= loopTo; i++)
                    {
                        ...
                        var aBoneController = new SourceMdlBoneController32();
        ...
        public void ReadHitboxSets()
        {
            if (theMdlFileData.hitboxSetCount > 0)
            {
                ...
                try
                {
                    ...
                    fileOffsetStart = theInputFileReader.BaseStream.Position;
                    theMdlFileData.theHitboxSets = new List<SourceMdlHitboxSet32>(theMdlFileData.hitboxSetCount);
                    for (int i = 0, loopTo = theMdlFileData.hitboxSetCount - 1; i <= loopTo; i++)
                    {
                        ...
                        var aHitboxSet = new SourceMdlHitboxSet32();
        ...
        public void ReadSequences()
        {
            if (theMdlFileData.localSequenceCount > 0)
            {
                ...
                try
                {
                    ...
                    theMdlFileData.theSequenceDescs = new List<SourceMdlSequenceDesc32>(theMdlFileData.localSequenceCount);
                    for (int i = 0, loopTo = theMdlFileData.localSequenceCount - 1; i <= loopTo; i++)
                    {
                        ...
                        fileOffsetStart = theInputFileReader.BaseStream.Position;
                        var aSeqDesc = new SourceMdlSequenceDesc32();
                        ...
                        aSeqDesc.animDescIndex = theInputFileReader.ReadInt32();
                        aSeqDesc.unknown = theInputFileReader.ReadInt32();
                        ...
                        inputFileStreamPosition = theInputFileReader.BaseStream.Position;
                        theInputFileReader.BaseStream.Seek(inputFileStreamPosition + 4096L, SeekOrigin.Begin);
        ...
        public void ReadLocalAnimationDescs()
        {
            if (theMdlFileData.animationCount > 0)
            {
                ...
                try
                {
                    ...
                    fileOffsetStart = theInputFileReader.BaseStream.Position;
                    theMdlFileData.theAnimationDescs = new List<SourceMdlAnimationDesc32>(theMdlFileData.animationCount);
                    for (int i = 0, loopTo = theMdlFileData.animationCount - 1; i <= loopTo; i++)
                    {
                        ...
                        // fileOffsetStart = Me.theInputFileReader.BaseStream.Position
                        var anAnimationDesc = new SourceMdlAnimationDesc32();
        ...
        private void ReadHitboxes(long hitboxSetInputFileStreamPosition, SourceMdlHitboxSet32 aHitboxSet)
        {
            if (aHitboxSet.hitboxCount > 0)
            {
                ...
                try
                {
                    ...
                    fileOffsetStart = theInputFileReader.BaseStream.Position;
                    aHitboxSet.theHitboxes = new List<SourceMdlHitbox32>(aHitboxSet.hitboxCount);
                    for (int j = 0, loopTo = aHitboxSet.hitboxCount - 1; j <= loopTo; j++)
                    {
                        ...
                        var aHitbox = new SourceMdlHitbox32();
        ...
        private void ReadPoseKeys(long seqInputFileStreamPosition, SourceMdlSequenceDesc32 aSeqDesc)
        {
        ...
        private void ReadEvents(long seqInputFileStreamPosition, SourceMdlSequenceDesc32 aSeqDesc)
        {
        ...
        private void ReadAutoLayers(long seqInputFileStreamPosition, SourceMdlSequenceDesc32 aSeqDesc)
        {
        ...
        private void ReadMdlAnimBoneWeights(long seqInputFileStreamPosition, SourceMdlSequenceDesc32 aSeqDesc)
        {
        ...
        private void ReadSequenceIkLocks(long seqInputFileStreamPosition, SourceMdlSequenceDesc32 aSeqDesc)
        {
        ...
        private void ReadSequenceKeyValues(long seqInputFileStreamPosition, SourceMdlSequenceDesc32 aSeqDesc)
        {
        ...
        private void ReadAnimations(long animationDescInputFileStreamPosition, SourceMdlAnimationDesc32 anAnimationDesc)
        {
        ...
        private void ReadMdlMovements(long animInputFileStreamPosition, SourceMdlAnimationDesc32 anAnimationDesc)
        {
        ...
        private void ReadMdlIkRules(long animInputFileStreamPosition, SourceMdlAnimationDesc32 anAnimationDesc)
        {
            ...
            if (aBodyPart.modelCount > 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = aBodyPart.modelCount - 1; j <= loopTo; j++)
                    {
                        ...
                        theMdlFileData.theFileSeekLog.LogToEndAndAlignToNextStart(theInputFileReader, fileOffsetEnd, 32, "aModel.theVertexes pre-alignment (NOTE: Should end at: " + (modelInputFileStreamPosition + aModel.vertexOffset - 1L).ToString() + ")");
                        ReadVertexes(modelInputFileStreamPosition, aModel);
                        fileOffsetEnd = theInputFileReader.BaseStream.Position - 1L;
                        theMdlFileData.theFileSeekLog.LogToEndAndAlignToNextStart(theInputFileReader, fileOffsetEnd, 4, "aModel.theTangents pre-alignment (NOTE: Should end at: " + (modelInputFileStreamPosition + aModel.tangentOffset - 1L).ToString() + ")");
        ...
        protected SourceMdlFileData32 theMdlFileData;
