...
namespace Crowbar
{
    public class SourceQcFile32 : SourceQcFile
    {

        #region Creation and Destruction

        public SourceQcFile32(StreamWriter outputFileStream, string outputPathFileName, SourceMdlFileData32 mdlFileData, SourcePhyFileData phyFileData, SourceVtxFileData06 vtxFileData, string modelName)
        {
        ...
        public void WriteModelCommand()
        {
            ...
            if (theMdlFileData.theBodyParts is object && theMdlFileData.theBodyParts.Count > 0)
            {
                line = "";
                theOutputFileStreamWriter.WriteLine(line);
                aBodyPart = theMdlFileData.theBodyParts[0];
                ...
                aBodyModel.theSmdFileNames[0] = SourceFileNamesModule.CreateBodyGroupSmdFileName(aBodyModel.theSmdFileNames[0], 0, 0, 0, theModelName, Conversions.ToString(aBodyModel.name));
                if (Program.TheApp.Settings.DecompileQcUseMixedCaseForKeywordsIsChecked)
                {
                    line = "$Model ";
                }
                ...
                WriteEyeballLines(ref eyeballNames);
                WriteEyelidLines(eyeballNames);
                WriteMouthLines();
        ...
        private void WriteEyelidLines(List<string> eyeballNames)
        {
            ...
            try
            {
                ...
                aBodyPart = theMdlFileData.theBodyParts[0];
                if (aBodyPart.theModels is object && aBodyPart.theModels.Count > 0 && theMdlFileData.theEyelidFlexFrameIndexes.Count > 0)
                {
                    aModel = aBodyPart.theModels[0];
                    if (aModel.theEyeballs is object && aModel.theEyeballs.Count > 0)
                    {
        ...
        public void WriteTextureFileNameComments()
        {
            ...
            if (theMdlFileData.theTextures is object)
            {
                string line;
                line = "";
                theOutputFileStreamWriter.WriteLine(line);
        ...
        public void WriteAttachmentCommand()
        {
            ...
            if (theMdlFileData.theAttachments is object)
            {
                ...
                {
                    SourceMdlAttachment37 anAttachment;
        ...
        public void WriteIncludeModelCommands()
        {
            ...
            if (theMdlFileData.theSequenceGroups is object)
            {
                line = "";
                theOutputFileStreamWriter.WriteLine(line);
                for (int i = 0, loopTo = theMdlFileData.theSequenceGroups.Count - 1; i <= loopTo; i++)
                {
                    SourceMdlSequenceGroup37 aModelGroup;
                    aModelGroup = theMdlFileData.theSequenceGroups[i];
        ...
        private void FillInWeightLists()
        {
            ...
            {
                SourceMdlSequenceDesc32 aSeqDesc;
        ...
        private void WriteAnimationOrDeclareAnimationCommand()
        {
            if (theMdlFileData.theAnimationDescs is object)
            {
                ...
                {
                    SourceMdlAnimationDesc32 anAnimationDesc;
        ...
        private void WriteAnimationLine(SourceMdlAnimationDesc32 anAnimationDesc)
        {
            string line = "";
            theOutputFileStreamWriter.WriteLine();
        ...
        private void WriteSequenceOrDeclareSequenceCommand()
        {
            ...
            if (theMdlFileData.theSequenceDescs is object)
            {
                for (int sequenceIndex = 0, loopTo = theMdlFileData.theSequenceDescs.Count - 1; sequenceIndex <= loopTo; sequenceIndex++)
                {
                    SourceMdlSequenceDesc32 aSequenceDesc;
                    aSequenceDesc = theMdlFileData.theSequenceDescs[sequenceIndex];
                    WriteSequenceLine(aSequenceDesc);
                }
            }
        }

        private void WriteSequenceLine(SourceMdlSequenceDesc32 aSequenceDesc)
        {
            string line = "";
            theOutputFileStreamWriter.WriteLine();
        ...
        private void WriteSequenceOptions(SourceMdlSequenceDesc32 aSequenceDesc)
        {
            string line = "";
            string valueString;
            SourceMdlAnimationDesc32 impliedAnimDesc = null;
            try
            {
                ...
                // ======
                SourceMdlAnimationDesc32 anAnimationDesc;
                anAnimationDesc = theMdlFileData.theAnimationDescs[aSequenceDesc.animDescIndex];
                line = Constants.vbTab;
                line += "\"";
                // anAnimationDesc.theSmdRelativePathFileName = SourceFileNamesModule.CreateAnimationSmdRelativePathFileName(anAnimationDesc.theSmdRelativePathFileName, Me.theModelName, anAnimationDesc.theName)
                // line += anAnimationDesc.theSmdRelativePathFileName
            ...
            {
                SourceMdlIkLock37 ikLock;
                for (int ikLockIndex = 0, loopTo = aSequenceDesc.theIkLocks.Count - 1; ikLockIndex <= loopTo; ikLockIndex++)
                {
            ...
            SourceMdlAnimationDesc32 firstAnimDesc;
            firstAnimDesc = theMdlFileData.theAnimationDescs[0];
        ...
        // lookupControl( token )       
        private void WriteAnimationOptions(SourceMdlSequenceDesc32 aSequenceDesc, SourceMdlAnimationDesc32 anAnimationDesc, SourceMdlAnimationDesc32 impliedAnimDesc)
        {
            string line = "";
            line = Constants.vbTab;
            line += "fps ";
        ...
        // worldspaceblend       //
        // worldspaceblendloop   // 
        private void WriteCmdListOptions(SourceMdlSequenceDesc32 aSequenceDesc, SourceMdlAnimationDesc32 anAnimationDesc, SourceMdlAnimationDesc32 impliedAnimDesc)
        {
            string line = "";
            ...
            // weightlist "top_bottom"
            SourceMdlSequenceDesc32 aSeqDesc = null;
            if (aSequenceDesc is null)
            {
        ...
        private void WriteSequenceWeightListLine(SourceMdlSequenceDesc32 aSeqDesc)
        {
            string line = "";
            if (theMdlFileData.theWeightLists is object && theMdlFileData.theWeightLists.Count > 0)
            {
                line = Constants.vbTab;
                line += "weightlist ";
        ...
        private void WriteSequenceBlendInfo(SourceMdlSequenceDesc32 aSeqDesc)
        {
            string line = "";
            if (theMdlFileData.thePoseParamDescs is object)
            {
        ...
        private void WriteSequenceDeltaInfo(SourceMdlSequenceDesc32 aSeqDesc)
        {
            string line = "";
        ...
        private void WriteSequenceLayerInfo(SourceMdlSequenceDesc32 aSeqDesc)
        {
            if (aSeqDesc.autoLayerCount > 0)
            {
                string line = "";
                SourceMdlAutoLayer37 layer;
        ...
        private void WriteHBoxRelatedCommands()
        {
            ...
            SourceMdlHitboxSet32 aHitboxSet;
        ...
        private void WriteHBoxCommands(List<SourceMdlHitbox32> theHitboxes, string commentTag, string hitboxSetName, ref bool theSkipBoneInBBoxCommandWasUsed)
        {
            string line = "";
            SourceMdlHitbox32 aHitbox;
        ...
        public void WriteBodyGroupCommand(int startIndex)
        {
            string line = "";
            SourceMdlBodyPart37 aBodyPart;
            SourceVtxBodyPart06 aVtxBodyPart;
            SourceMdlModel37 aBodyModel;
            SourceVtxModel06 aVtxModel;
            ...
            // blank
            // }
            if (theMdlFileData.theBodyParts is object && theMdlFileData.theBodyParts.Count > startIndex)
            {
                line = "";
                theOutputFileStreamWriter.WriteLine(line);
                for (int bodyPartIndex = startIndex, loopTo = theMdlFileData.theBodyParts.Count - 1; bodyPartIndex <= loopTo; bodyPartIndex++)
                {
        ...
        {
            string line = "";
            SourceMdlBoneController32 boneController;
