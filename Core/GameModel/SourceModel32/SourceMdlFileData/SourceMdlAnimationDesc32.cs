...
namespace Crowbar
{
    public class SourceMdlAnimationDesc32 : SourceMdlAnimationDescBase
    {
        ...
        public List<SourceMdlSequenceDesc32> theLinkedSequences = new List<SourceMdlSequenceDesc32>();
    }
}