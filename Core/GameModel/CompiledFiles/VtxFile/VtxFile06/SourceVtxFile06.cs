            ...
            if (theVtxFileData.bodyPartCount > 0 && theVtxFileData.bodyPartOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theVtxFileData.bodyPartCount - 1; i <= loopTo; i++)
                    {
                        ...
                        var aBodyPart = new SourceVtxBodyPart06();
            ...
            if (theVtxFileData.materialReplacementListOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0, loopTo = theVtxFileData.lodCount - 1; i <= loopTo; i++)
                    {
                        ...
                        var aMaterialReplacementList = new SourceVtxMaterialReplacementList06();
            ...
            if (aBodyPart.modelCount > 0 && aBodyPart.modelOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = aBodyPart.modelCount - 1; j <= loopTo; j++)
                    {
                        ...
                        var aModel = new SourceVtxModel06();
            ...
            if (aModel.lodCount > 0 && aModel.lodOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = aModel.lodCount - 1; j <= loopTo; j++)
                    {
                        ...
                        var aModelLod = new SourceVtxModelLod06();
            ...
            if (aMesh.stripGroupCount > 0 && aMesh.stripGroupOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = aMesh.stripGroupCount - 1; j <= loopTo; j++)
                    {
                        ...
                        var aStripGroup = new SourceVtxStripGroup06();
            ...
            if (aStripGroup.vertexCount > 0 && aStripGroup.vertexOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = aStripGroup.vertexCount - 1; j <= loopTo; j++)
                    {
                        ...
                        var aVertex = new SourceVtxVertex06();
                        for (int x = 0, loopTo1 = aVertex.boneWeightIndex.Length - 1; x <= loopTo1; x++)
            ...
            if (aStripGroup.stripCount > 0 && aStripGroup.stripOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = aStripGroup.stripCount - 1; j <= loopTo; j++)
                    {
                        ...
                        var aStrip = new SourceVtxStrip06();
            ...
            if (boneStateChangeCount > 0 && aStrip.boneStateChangeOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = boneStateChangeCount - 1; j <= loopTo; j++)
                    {
                        ...
                        var aBoneStateChange = new SourceVtxBoneStateChange06();
            ...
            if (aMaterialReplacementList.replacementCount > 0 && aMaterialReplacementList.replacementOffset != 0)
            {
                ...
                try
                {
                    ...
                    for (int j = 0, loopTo = aMaterialReplacementList.replacementCount - 1; j <= loopTo; j++)
                    {
                        ...
                        var aMaterialReplacement = new SourceVtxMaterialReplacement06();
