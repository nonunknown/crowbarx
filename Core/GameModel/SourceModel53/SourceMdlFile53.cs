...
namespace Crowbar
{
    public class SourceMdlFile53
    {
        ...
        public void ReadMdlHeader00(string logDescription)
        {
            ...
            theMdlFileData.theNameCopy = GetStringAtOffset(0L, theMdlFileData.nameCopyOffset, "theNameCopy");
        ...
        public void ReadMdlHeader01(string logDescription)
        {
            ...
            // End If
            // ------
            theMdlFileData.theSurfacePropName = GetStringAtOffset(0L, theMdlFileData.surfacePropOffset, "theSurfacePropName");
            ...
            for (int x = 0, loopTo1 = theMdlFileData.unknown.Length - 1; x <= loopTo1; x++)
        ...
        protected void ReadAnimationFrameByBone(long animInputFileStreamPosition, SourceMdlAnimationDesc52 anAnimationDesc, int sectionFrameCount, int sectionIndex, bool lastSectionIsBeingRead)
        {
            ...
            try
            {
                ...
                if (aSectionOfAnimation.frameOffset != 0)
                {
                    ...
                    for (int frameIndex = 0, loopTo3 = sectionFrameCount - 1; frameIndex <= loopTo3; frameIndex++)
                    {
